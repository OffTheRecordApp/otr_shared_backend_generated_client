...
export class DripWebhooksControllerService {
     ...
     */
    public handleBounceOrComplaintEventUsingPOST(request: DripWebhookEvent, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<object>;
    public handleBounceOrComplaintEventUsingPOST(request: DripWebhookEvent, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<object>>;
    public handleBounceOrComplaintEventUsingPOST(request: DripWebhookEvent, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<object>>;
    public handleBounceOrComplaintEventUsingPOST(request: DripWebhookEvent, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/api/v1/webhooks/drip/bounce-or-complaint`;
