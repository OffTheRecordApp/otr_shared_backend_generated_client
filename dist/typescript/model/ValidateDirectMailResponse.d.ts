...
export declare namespace ValidateDirectMailResponse {
    enum OtrErrorEnum {
        ...
        ACTIVESUBSCRIPTIONBLOCKSACCOUNTDELETION,
        ADMINACTIVESUBSCRIPTIONBLOCKSACCOUNTDELETION,
        ADMINHOUSEHOLDMATEBLOCKSACCOUNTDELETION,
        ARAGNOTCAPTURED,
        ...
        CANNOTPURCHASESUBWITHOTHERCOVERAGE,
        CASEALREADYEXISTS,
        CASEALREADYPAID,
        CASEALREADYRESOLVED,
        CASECOUNTERMISMATCH,
        ...
        GHOSTUSERNOTALLOWED,
        HOUSEHOLDMATEBLOCKSACCOUNTDELETION,
