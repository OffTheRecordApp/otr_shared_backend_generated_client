...
export class LawfirmDocumentControllerApi {
     ...
     */
    public generateDocUsingPOST (docType: 'ENGAGEMENT_LETTER' | 'OTHER_DOCUMENT' | 'OTHER_IMAGE', lawfirmId: string, request?: models.GetDocumentsRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentResponse> {
     ...
     * @param lawfirmId lawfirmId
     */
    public getDocumentUsingGET (docType: 'ENGAGEMENT_LETTER' | 'OTHER_DOCUMENT' | 'OTHER_IMAGE', lawfirmId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentTemplateResponse> {
        const localVarPath = this.basePath + '/api/v1/lawfirms/{lawfirmId}/documents'
            .replace('{' + 'lawfirmId' + '}', encodeURIComponent(String(lawfirmId)));
     ...
     * @param request request
     */
    public previewDocUsingPOST (docType: 'ENGAGEMENT_LETTER' | 'OTHER_DOCUMENT' | 'OTHER_IMAGE', lawfirmId: string, request: models.PreviewDocumentRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentResponse> {
