...
export class FreshdeskTicketControllerApi {
     ...
     */
    public mergeTicketUsingPOST (ticketId: number, request: models.FreshdeskWebhookRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MergeTicketResponse> {
     ...
     * @param request request
     */
    public updateFreshdeskTicketUsingPUT (ticketId: number, request: models.FreshDeskTicketReq, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.FreshDeskTicketRes> {
