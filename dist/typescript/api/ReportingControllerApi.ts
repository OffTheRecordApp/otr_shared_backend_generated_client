...
export class ReportingControllerApi {
     ...
     */
    public getCourtCoverageForCountyReportUsingGET (countyId: number, regionCode: string, urWindowInDays?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetCourtCoverageForCountyReportResponse> {
     ...
     * @param regionCode regionCode
     */
    public getLawfirmCoverageReportUsingGET (countyId?: number, regionCode?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetLawfirmCoverageReportResponse> {
