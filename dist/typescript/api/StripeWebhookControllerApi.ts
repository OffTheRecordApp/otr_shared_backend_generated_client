...
export class StripeWebhookControllerApi {
     ...
     */
    public handleStripeWebhookForSubscriptionsUsingPOST (request?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
     ...
     * @param request request
     */
    public handleStripeWebhookFromLawfirmConnectedAccountsUsingPOST (request?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
     ...
     * @param request request
     */
    public handleStripeWebhookFromOTRConnectedAccountsUsingPOST (request?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<string> {
