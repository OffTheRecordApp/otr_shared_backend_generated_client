...
export class LawfirmControllerApi {
     ...
     * @param query query
     */
    public getInboxMessagesUsingGET (lawfirmId: number, filter?: 'ARCHIVE' | 'DEFAULT' | 'FLAG_ONLY' | 'STAR_ONLY', length?: number, page?: number, query?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetLawfirmInboxMessagesResponse> {
