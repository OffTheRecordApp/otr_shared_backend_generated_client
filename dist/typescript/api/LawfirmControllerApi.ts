...
export class LawfirmControllerApi {
     ...
     * @param page page
     */
    public getInboxMessagesUsingGET (lawfirmId: number, filter?: 'ARCHIVE' | 'DEFAULT' | 'FLAG_ONLY' | 'STAR_ONLY', length?: number, page?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetLawfirmInboxMessagesResponse> {
