...
export class WatchlistControllerApi {
     ...
     */
    public listUserWatchlistsUsingGET (userId: number, isArchived?: boolean, watchlistId?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ListUserWatchlistsResponse> {
