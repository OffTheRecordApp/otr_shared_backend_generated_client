...
export class TicketReviewControllerApi {
     ...
     * @param request request
     */
    public updateTicketEvaluationRequestUsingPUT (ticketEvaluationRequestId: number, request: models.TicketReviewRequestReq, extraHttpRequestParams?: any ) : ng.IHttpPromise<object> {
