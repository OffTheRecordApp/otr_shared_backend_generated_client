...
export class SnsListenerControllerApi {
     ...
     */
    public handleBounceComplaintEmailsUsingPOST (request: models.SNSNotificationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<object> {
     ...
     * @param request request
     */
    public handleIncomingEmailsUsingPOST (request: models.IncomingEmailRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     * @param request request
     */
    public handleIncomingHelloEmailsUsingPOST (request: models.IncomingEmailModels, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
