...
exports.UserSearchControllerApi = void 0;
/* tslint:disable:no-unused-variable member-ordering */
var UserSearchControllerApi = /** @class */ (function () {
    function UserSearchControllerApi($http, $httpParamSerializer, basePath) {
        this.$http = $http;
     ...
     */
    UserSearchControllerApi.prototype.findMatchingUsersUsingPOST = function (request, extraHttpRequestParams) {
        var localVarPath = this.basePath + '/api/v1/users/search';
        var queryParameters = {};
    ...
    UserSearchControllerApi.$inject = ['$http', '$httpParamSerializer', 'basePath'];
