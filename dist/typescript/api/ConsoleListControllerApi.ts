...
export class ConsoleListControllerApi {
     ...
     * @param request request
     */
    public getCasesWithMissingLawfirmPayoutsUsingPOST (request: models.GetCasesWithMissingLawfirmPayoutsRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetCasesWithMissingLawfirmPayoutsResponse> {
