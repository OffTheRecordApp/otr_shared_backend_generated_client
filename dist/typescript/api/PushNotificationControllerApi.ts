...
export class PushNotificationControllerApi {
     ...
     */
    public markNotificationAsUnreadUsingPUT (userId: number, request: models.MarkNotificationAsUnreadRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
        const localVarPath = this.basePath + '/api/v1/notifications/unread/{userId}/message'
            .replace('{' + 'userId' + '}', encodeURIComponent(String(userId)));
