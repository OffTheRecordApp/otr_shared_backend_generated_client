...
export class CasePaymentControllerApi {
     ...
     */
    public generateCasePaymentPlanUsingGET (caseId: string, paymentPlanTypeId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ListCostItemsForCustomerResponse> {
     ...
     * @param caseId caseId
     */
    public listCostItemsForCustomerUsingGET (caseId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ListCostItemsForCustomerResponse> {
     ...
     */
    public updatePaymentRecipientUsingPUT (casePaymentId: string, recipient: 'LAWFIRM' | 'OTR', extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
