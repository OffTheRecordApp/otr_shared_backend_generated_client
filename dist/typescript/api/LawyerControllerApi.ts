...
export class LawyerControllerApi {
     ...
     * @param userId userId
     */
    public cancelLawyerInviteUsingDELETE (inviteeEmail: string, userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     */
    public deleteLawyerUsingDELETE (userId: number, removeAdminOnly?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
     ...
     * @param userId userId
     */
    public getLawyerUsingGET (userId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetLawyerResponse> {
        const localVarPath = this.basePath + '/api/v1/lawyers/{userId}'
            .replace('{' + 'userId' + '}', encodeURIComponent(String(userId)));
     ...
     * @param request request
     */
    public inviteLawyerToLawfirmUsingPOST (lawfirmId: number, userId: number, request: models.InviteLawyerToLawfirmRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
