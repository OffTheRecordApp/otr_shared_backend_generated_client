...
export class CaseActionsControllerApi {
     ...
     */
    public markActionAsDeletedUsingDELETE (caseActionId: string, caseId: string, isDeleted?: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.MarkActionAsDeletedResponse> {
