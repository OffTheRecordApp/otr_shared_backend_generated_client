...
export function PriceMatchRequestFromJSON(json: any): PriceMatchRequest {
    return PriceMatchRequestFromJSONTyped(json, false);
}

export function PriceMatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceMatchRequest {
...
export function PriceMatchRequestToJSON(value?: PriceMatchRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
