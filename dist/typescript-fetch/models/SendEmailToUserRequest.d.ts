...
export declare function SendEmailToUserRequestFromJSON(json: any): SendEmailToUserRequest;
export declare function SendEmailToUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendEmailToUserRequest;
export declare function SendEmailToUserRequestToJSON(value?: SendEmailToUserRequest | null): any;
/**
* @export
* @enum {string}
*/
