...
export function WorkflowViolationModelFromJSON(json: any): WorkflowViolationModel {
    return WorkflowViolationModelFromJSONTyped(json, false);
}

export function WorkflowViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkflowViolationModel {
    ...
    return {
        ...
        'penalties': !exists(json, 'penalties') ? undefined : ((json['penalties'] as Array<any>).map(WorkflowViolationPenaltyModelFromJSON)),
...
export function WorkflowViolationModelToJSON(value?: WorkflowViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'penalties': value.penalties === undefined ? undefined : ((value.penalties as Array<any>).map(WorkflowViolationPenaltyModelToJSON)),
...
* @enum {string}
*/
export enum WorkflowViolationModelViolationClassificationEnum {
