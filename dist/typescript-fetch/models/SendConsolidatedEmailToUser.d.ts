...
export declare function SendConsolidatedEmailToUserFromJSON(json: any): SendConsolidatedEmailToUser;
export declare function SendConsolidatedEmailToUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendConsolidatedEmailToUser;
export declare function SendConsolidatedEmailToUserToJSON(value?: SendConsolidatedEmailToUser | null): any;
/**
* @export
* @enum {string}
*/
