...
export function CitationAuditEventModelFromJSON(json: any): CitationAuditEventModel {
    return CitationAuditEventModelFromJSONTyped(json, false);
}

export function CitationAuditEventModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationAuditEventModel {
...
export function CitationAuditEventModelToJSON(value?: CitationAuditEventModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum CitationAuditEventModelClientTypeEnum {
    ANDROID = 'ANDROID',
...
* @enum {string}
*/
export enum CitationAuditEventModelEventEnum {
