...
export declare function AddViolationRequestFromJSON(json: any): AddViolationRequest;
export declare function AddViolationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddViolationRequest;
export declare function AddViolationRequestToJSON(value?: AddViolationRequest | null): any;
/**
* @export
* @enum {string}
*/
