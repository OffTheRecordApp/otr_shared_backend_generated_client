...
export function GenerateTemplateRequestFromJSON(json: any): GenerateTemplateRequest {
    return GenerateTemplateRequestFromJSONTyped(json, false);
}

export function GenerateTemplateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenerateTemplateRequest {
...
export function GenerateTemplateRequestToJSON(value?: GenerateTemplateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
