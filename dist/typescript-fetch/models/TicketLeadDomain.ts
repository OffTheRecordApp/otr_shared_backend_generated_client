...
export function TicketLeadDomainFromJSON(json: any): TicketLeadDomain {
    return TicketLeadDomainFromJSONTyped(json, false);
}

export function TicketLeadDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): TicketLeadDomain {
    ...
    return {
        ...
        'notes': !exists(json, 'notes') ? undefined : ((json['notes'] as Array<any>).map(NoteEntityFromJSON)),
...
export function TicketLeadDomainToJSON(value?: TicketLeadDomain | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'notes': value.notes === undefined ? undefined : ((value.notes as Array<any>).map(NoteEntityToJSON)),
