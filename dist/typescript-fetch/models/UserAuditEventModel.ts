...
export function UserAuditEventModelFromJSON(json: any): UserAuditEventModel {
    return UserAuditEventModelFromJSONTyped(json, false);
}

export function UserAuditEventModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserAuditEventModel {
...
export function UserAuditEventModelToJSON(value?: UserAuditEventModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum UserAuditEventModelClientTypeEnum {
    ANDROID = 'ANDROID',
...
* @enum {string}
*/
export enum UserAuditEventModelEventEnum {
...
* @enum {string}
*/
export enum UserAuditEventModelEventTypeEnum {
    ACCOUNTCOVERAGEADDED = 'ACCOUNT_COVERAGE_ADDED',
    ACCOUNTCOVERAGEREMOVED = 'ACCOUNT_COVERAGE_REMOVED',
    ACCOUNTNOTIFICATIONSTATUSCHANGED = 'ACCOUNT_NOTIFICATION_STATUS_CHANGED',
    ACCOUNTSTATUSCHANGED = 'ACCOUNT_STATUS_CHANGED',
