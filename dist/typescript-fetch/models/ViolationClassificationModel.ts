...
export function ViolationClassificationModelFromJSON(json: any): ViolationClassificationModel {
    return ViolationClassificationModelFromJSONTyped(json, false);
}

export function ViolationClassificationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ViolationClassificationModel {
...
export function ViolationClassificationModelToJSON(value?: ViolationClassificationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
