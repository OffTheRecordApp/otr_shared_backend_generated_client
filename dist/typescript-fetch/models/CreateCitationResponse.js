...
export function CreateCitationResponseFromJSON(json) {
    return CreateCitationResponseFromJSONTyped(json, false);
}
export function CreateCitationResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateCitationResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
