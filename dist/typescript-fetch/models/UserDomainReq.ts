...
import {
    ...
    PhoneNumberDomainReqFromJSON,
    PhoneNumberDomainReqFromJSONTyped,
    PhoneNumberDomainReqToJSON,
    TimestampReq,
    ...
    UserReferralLinkModelReqFromJSONTyped,
    UserReferralLinkModelReqToJSON,
    UserRoleDomain,
    UserRoleDomainFromJSON,
    UserRoleDomainFromJSONTyped,
    UserRoleDomainToJSON,
    UserSocialProfileModelReq,
    UserSocialProfileModelReqFromJSON,
    UserSocialProfileModelReqFromJSONTyped,
    UserSocialProfileModelReqToJSON,
    UserSubscriptionPlanModelReq,
    UserSubscriptionPlanModelReqFromJSON,
    UserSubscriptionPlanModelReqFromJSONTyped,
    UserSubscriptionPlanModelReqToJSON,
} from './';
...
export function UserDomainReqFromJSON(json: any): UserDomainReq {
    return UserDomainReqFromJSONTyped(json, false);
}

export function UserDomainReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserDomainReq {
    ...
    return {
        ...
        'phoneNumbers': !exists(json, 'phoneNumbers') ? undefined : ((json['phoneNumbers'] as Array<any>).map(PhoneNumberDomainReqFromJSON)),
        ...
        'referralLinks': !exists(json, 'referralLinks') ? undefined : ((json['referralLinks'] as Array<any>).map(UserReferralLinkModelReqFromJSON)),
        ...
        'socialProfiles': !exists(json, 'socialProfiles') ? undefined : ((json['socialProfiles'] as Array<any>).map(UserSocialProfileModelReqFromJSON)),
        'subscriptionPlans': !exists(json, 'subscriptionPlans') ? undefined : ((json['subscriptionPlans'] as Array<any>).map(UserSubscriptionPlanModelReqFromJSON)),
...
export function UserDomainReqToJSON(value?: UserDomainReq | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'phoneNumbers': value.phoneNumbers === undefined ? undefined : ((value.phoneNumbers as Array<any>).map(PhoneNumberDomainReqToJSON)),
        ...
        'referralLinks': value.referralLinks === undefined ? undefined : ((value.referralLinks as Array<any>).map(UserReferralLinkModelReqToJSON)),
        ...
        'socialProfiles': value.socialProfiles === undefined ? undefined : ((value.socialProfiles as Array<any>).map(UserSocialProfileModelReqToJSON)),
        'subscriptionPlans': value.subscriptionPlans === undefined ? undefined : ((value.subscriptionPlans as Array<any>).map(UserSubscriptionPlanModelReqToJSON)),
...
* @enum {string}
*/
export enum UserDomainReqGenderTypeEnum {
    FEMALE = 'FEMALE',
    MALE = 'MALE',
...
* @enum {string}
*/
export enum UserDomainReqRaceEnum {
    ASIAN = 'ASIAN',
    BLACK = 'BLACK',
    HISPANIC = 'HISPANIC',
