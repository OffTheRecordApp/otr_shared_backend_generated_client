...
export declare function AccountLevelFeeFromJSON(json: any): AccountLevelFee;
export declare function AccountLevelFeeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountLevelFee;
export declare function AccountLevelFeeToJSON(value?: AccountLevelFee | null): any;
/**
* @export
* @enum {string}
*/
