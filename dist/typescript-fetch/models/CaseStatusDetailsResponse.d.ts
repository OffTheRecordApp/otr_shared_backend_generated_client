...
export declare function CaseStatusDetailsResponseFromJSON(json: any): CaseStatusDetailsResponse;
export declare function CaseStatusDetailsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CaseStatusDetailsResponse;
export declare function CaseStatusDetailsResponseToJSON(value?: CaseStatusDetailsResponse | null): any;
/**
* @export
* @enum {string}
*/
