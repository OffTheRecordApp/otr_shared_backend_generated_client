...
export function ResetViolationModelFromJSON(json: any): ResetViolationModel {
    return ResetViolationModelFromJSONTyped(json, false);
}

export function ResetViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResetViolationModel {
...
export function ResetViolationModelToJSON(value?: ResetViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
