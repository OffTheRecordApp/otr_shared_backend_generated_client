...
export interface AddCourtCoverageRequest {
     ...
     */
    classification?: AddCourtCoverageRequestClassificationEnum;
    /**
     *
     * @type {number}
     * @memberof AddCourtCoverageRequest
...
export declare function AddCourtCoverageRequestFromJSON(json: any): AddCourtCoverageRequest;
export declare function AddCourtCoverageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddCourtCoverageRequest;
export declare function AddCourtCoverageRequestToJSON(value?: AddCourtCoverageRequest | null): any;
/**
* @export
* @enum {string}
*/
export declare enum AddCourtCoverageRequestClassificationEnum {
