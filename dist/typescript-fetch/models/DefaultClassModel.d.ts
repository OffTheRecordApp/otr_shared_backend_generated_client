...
export declare function DefaultClassModelFromJSON(json: any): DefaultClassModel;
export declare function DefaultClassModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultClassModel;
export declare function DefaultClassModelToJSON(value?: DefaultClassModel | null): any;
/**
* @export
* @enum {string}
*/
