...
export declare function ViolationClassificationModelFromJSON(json: any): ViolationClassificationModel;
export declare function ViolationClassificationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ViolationClassificationModel;
export declare function ViolationClassificationModelToJSON(value?: ViolationClassificationModel | null): any;
/**
* @export
* @enum {string}
*/
