...
export interface CoverageToRemove {
     ...
     */
    classification?: CoverageToRemoveClassificationEnum;
    /**
     *
     * @type {number}
     * @memberof CoverageToRemove
...
export declare function CoverageToRemoveFromJSON(json: any): CoverageToRemove;
export declare function CoverageToRemoveFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoverageToRemove;
export declare function CoverageToRemoveToJSON(value?: CoverageToRemove | null): any;
/**
* @export
* @enum {string}
*/
export declare enum CoverageToRemoveClassificationEnum {
