...
export declare enum ValidateDirectMailResponseOtrErrorEnum {
    ...
    ACTIVESUBSCRIPTIONBLOCKSACCOUNTDELETION = "ACTIVE_SUBSCRIPTION_BLOCKS_ACCOUNT_DELETION",
    ADMINACTIVESUBSCRIPTIONBLOCKSACCOUNTDELETION = "ADMIN_ACTIVE_SUBSCRIPTION_BLOCKS_ACCOUNT_DELETION",
    ADMINHOUSEHOLDMATEBLOCKSACCOUNTDELETION = "ADMIN_HOUSEHOLD_MATE_BLOCKS_ACCOUNT_DELETION",
    ...
    CANNOTPURCHASESUBWITHOTHERCOVERAGE = "CANNOT_PURCHASE_SUB_WITH_OTHER_COVERAGE",
    ...
    CITATIONIMAGEUPDATENOTALLOWED = "CITATION_IMAGE_UPDATE_NOT_ALLOWED",
    ...
    CODENOTALLOWEDDUETOPROMOOFFER = "CODE_NOT_ALLOWED_DUE_TO_PROMO_OFFER",
    ...
    HOUSEHOLDMATEBLOCKSACCOUNTDELETION = "HOUSEHOLD_MATE_BLOCKS_ACCOUNT_DELETION",
    ...
    LETTEROFENGAGEMENTFAILURE = "LETTER_OF_ENGAGEMENT_FAILURE",
    ...
    PHONENUMBERNOTCELLULAR = "PHONE_NUMBER_NOT_CELLULAR",
