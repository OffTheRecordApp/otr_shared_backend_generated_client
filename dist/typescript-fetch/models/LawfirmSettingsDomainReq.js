...
export function LawfirmSettingsDomainReqFromJSON(json) {
    return LawfirmSettingsDomainReqFromJSONTyped(json, false);
}
export function LawfirmSettingsDomainReqFromJSONTyped(json, ignoreDiscriminator) {
...
* @enum {string}
*/
export var LawfirmSettingsDomainReqReferralFeeTypeEnum;
...
})(LawfirmSettingsDomainReqReferralFeeTypeEnum || (LawfirmSettingsDomainReqReferralFeeTypeEnum = {}));
