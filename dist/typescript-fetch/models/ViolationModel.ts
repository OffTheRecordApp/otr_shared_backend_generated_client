...
import {
    ...
    ViolationPenaltyModelFromJSON,
    ViolationPenaltyModelFromJSONTyped,
    ViolationPenaltyModelToJSON,
} from './';
...
export function ViolationModelFromJSON(json: any): ViolationModel {
    return ViolationModelFromJSONTyped(json, false);
}

export function ViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ViolationModel {
    ...
    return {
        ...
        'penalties': !exists(json, 'penalties') ? undefined : ((json['penalties'] as Array<any>).map(ViolationPenaltyModelFromJSON)),
...
export function ViolationModelToJSON(value?: ViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'penalties': value.penalties === undefined ? undefined : ((value.penalties as Array<any>).map(ViolationPenaltyModelToJSON)),
...
* @enum {string}
*/
export enum ViolationModelViolationClassificationEnum {
