...
export declare function GraphRequestFromJSON(json: any): GraphRequest;
export declare function GraphRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GraphRequest;
export declare function GraphRequestToJSON(value?: GraphRequest | null): any;
/**
* @export
* @enum {string}
*/
