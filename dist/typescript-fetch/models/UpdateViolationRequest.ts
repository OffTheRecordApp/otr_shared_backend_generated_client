...
export interface UpdateViolationRequest {
     ...
     * @memberof UpdateViolationRequest
     */
    refundEligibilityType?: UpdateViolationRequestRefundEligibilityTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof UpdateViolationRequest
...
export function UpdateViolationRequestFromJSON(json: any): UpdateViolationRequest {
    return UpdateViolationRequestFromJSONTyped(json, false);
}

export function UpdateViolationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateViolationRequest {
...
export function UpdateViolationRequestToJSON(value?: UpdateViolationRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum UpdateViolationRequestRefundEligibilityTypeEnum {
