 ...
 * 
 * @export
 * @interface OCRViolationModel
 */
export interface OCRViolationModel {
    /**
     * 
     * @type {string}
     * @memberof OCRViolationModel
     */
     ...
     * @memberof OCRViolationModel
     */
    violationClassification?: OCRViolationModelViolationClassificationEnum;
    /**
     * 
     * @type {string}
     * @memberof OCRViolationModel
...
export function OCRViolationModelFromJSON(json: any): OCRViolationModel {
    return OCRViolationModelFromJSONTyped(json, false);
}

export function OCRViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): OCRViolationModel {
...
export function OCRViolationModelToJSON(value?: OCRViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum OCRViolationModelViolationClassificationEnum {
