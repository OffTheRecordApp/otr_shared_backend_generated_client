...
export declare function AddViolationResponseFromJSON(json: any): AddViolationResponse;
export declare function AddViolationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddViolationResponse;
export declare function AddViolationResponseToJSON(value?: AddViolationResponse | null): any;
/**
* @export
* @enum {string}
*/
export declare enum AddViolationResponseRefundEligibilityTypeEnum {
