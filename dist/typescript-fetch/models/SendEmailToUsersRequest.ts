...
import {
    UserToContact,
    UserToContactFromJSON,
    UserToContactFromJSONTyped,
    UserToContactToJSON,
} from './';
...
export function SendEmailToUsersRequestFromJSON(json: any): SendEmailToUsersRequest {
    return SendEmailToUsersRequestFromJSONTyped(json, false);
}

export function SendEmailToUsersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendEmailToUsersRequest {
    ...
    return {
        ...
        'usersToContact': !exists(json, 'usersToContact') ? undefined : ((json['usersToContact'] as Array<any>).map(UserToContactFromJSON)),
    };
}

export function SendEmailToUsersRequestToJSON(value?: SendEmailToUsersRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'usersToContact': value.usersToContact === undefined ? undefined : ((value.usersToContact as Array<any>).map(UserToContactToJSON)),
    };
}
