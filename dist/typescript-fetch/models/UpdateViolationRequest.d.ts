...
export declare function UpdateViolationRequestFromJSON(json: any): UpdateViolationRequest;
export declare function UpdateViolationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateViolationRequest;
export declare function UpdateViolationRequestToJSON(value?: UpdateViolationRequest | null): any;
/**
* @export
* @enum {string}
*/
...
* @enum {string}
*/
export declare enum UpdateViolationRequestRefundEligibilityTypeEnum {
