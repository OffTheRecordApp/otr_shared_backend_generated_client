...
export interface AddViolationResponse {
     ...
     * @memberof AddViolationResponse
     */
    refundEligibilityType?: AddViolationResponseRefundEligibilityTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof AddViolationResponse
...
export function AddViolationResponseFromJSON(json: any): AddViolationResponse {
    return AddViolationResponseFromJSONTyped(json, false);
}

export function AddViolationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddViolationResponse {
...
export function AddViolationResponseToJSON(value?: AddViolationResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum AddViolationResponseRefundEligibilityTypeEnum {
