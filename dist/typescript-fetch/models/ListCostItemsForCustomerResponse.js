...
export function ListCostItemsForCustomerResponseFromJSON(json) {
    return ListCostItemsForCustomerResponseFromJSONTyped(json, false);
}
export function ListCostItemsForCustomerResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ListCostItemsForCustomerResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
