...
export declare function ResetViolationModelFromJSON(json: any): ResetViolationModel;
export declare function ResetViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResetViolationModel;
export declare function ResetViolationModelToJSON(value?: ResetViolationModel | null): any;
/**
* @export
* @enum {string}
*/
