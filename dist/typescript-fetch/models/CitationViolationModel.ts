...
export function CitationViolationModelFromJSON(json: any): CitationViolationModel {
    return CitationViolationModelFromJSONTyped(json, false);
}

export function CitationViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationViolationModel {
...
export function CitationViolationModelToJSON(value?: CitationViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum CitationViolationModelViolationClassificationEnum {
