 ...
 */
import { CaseViolationPenalty } from './';
/**
 *
 * @export
...
export declare function ViolationResponseFromJSON(json: any): ViolationResponse;
export declare function ViolationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ViolationResponse;
export declare function ViolationResponseToJSON(value?: ViolationResponse | null): any;
/**
* @export
* @enum {string}
*/
