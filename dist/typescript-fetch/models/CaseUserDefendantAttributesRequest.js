...
export function CaseUserDefendantAttributesRequestFromJSON(json) {
    return CaseUserDefendantAttributesRequestFromJSONTyped(json, false);
}
export function CaseUserDefendantAttributesRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function CaseUserDefendantAttributesRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
