...
export declare function OCRViolationModelFromJSON(json: any): OCRViolationModel;
export declare function OCRViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): OCRViolationModel;
export declare function OCRViolationModelToJSON(value?: OCRViolationModel | null): any;
/**
* @export
* @enum {string}
*/
export declare enum OCRViolationModelViolationClassificationEnum {
