...
export function UpdateAddressFromJSON(json) {
    return UpdateAddressFromJSONTyped(json, false);
}
export function UpdateAddressFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateAddressToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
