...
export function AccountLevelFeeFromJSON(json: any): AccountLevelFee {
    return AccountLevelFeeFromJSONTyped(json, false);
}

export function AccountLevelFeeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountLevelFee {
...
export function AccountLevelFeeToJSON(value?: AccountLevelFee | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
