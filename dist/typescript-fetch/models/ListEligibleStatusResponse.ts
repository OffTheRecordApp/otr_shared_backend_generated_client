...
export function ListEligibleStatusResponseFromJSON(json: any): ListEligibleStatusResponse {
    return ListEligibleStatusResponseFromJSONTyped(json, false);
}

export function ListEligibleStatusResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListEligibleStatusResponse {
...
export function ListEligibleStatusResponseToJSON(value?: ListEligibleStatusResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
