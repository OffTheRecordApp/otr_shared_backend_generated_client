...
export declare function LawfirmAuditEventModelFromJSON(json: any): LawfirmAuditEventModel;
export declare function LawfirmAuditEventModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): LawfirmAuditEventModel;
export declare function LawfirmAuditEventModelToJSON(value?: LawfirmAuditEventModel | null): any;
/**
* @export
* @enum {string}
*/
