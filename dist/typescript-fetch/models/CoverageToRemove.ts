...
export function CoverageToRemoveFromJSON(json: any): CoverageToRemove {
    return CoverageToRemoveFromJSONTyped(json, false);
}

export function CoverageToRemoveFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoverageToRemove {
...
export function CoverageToRemoveToJSON(value?: CoverageToRemove | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum CoverageToRemoveClassificationEnum {
