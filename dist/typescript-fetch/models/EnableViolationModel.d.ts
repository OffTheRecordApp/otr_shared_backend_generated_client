...
export declare function EnableViolationModelFromJSON(json: any): EnableViolationModel;
export declare function EnableViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableViolationModel;
export declare function EnableViolationModelToJSON(value?: EnableViolationModel | null): any;
/**
* @export
* @enum {string}
*/
