 ...
 */
import { GetCompetitionResponseModel } from './';
/**
 *
 * @export
...
export declare function GetLawfirmFeeModelFromJSON(json: any): GetLawfirmFeeModel;
export declare function GetLawfirmFeeModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLawfirmFeeModel;
export declare function GetLawfirmFeeModelToJSON(value?: GetLawfirmFeeModel | null): any;
/**
* @export
* @enum {string}
*/
