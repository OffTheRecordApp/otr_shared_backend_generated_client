...
export function CaseWithCoverageObtainedFromJSON(json: any): CaseWithCoverageObtained {
    return CaseWithCoverageObtainedFromJSONTyped(json, false);
}

export function CaseWithCoverageObtainedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CaseWithCoverageObtained {
...
export function CaseWithCoverageObtainedToJSON(value?: CaseWithCoverageObtained | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
