...
export function AddViolationRequestFromJSON(json: any): AddViolationRequest {
    return AddViolationRequestFromJSONTyped(json, false);
}

export function AddViolationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddViolationRequest {
...
export function AddViolationRequestToJSON(value?: AddViolationRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
