...
export function LawfirmCaseModelResFromJSON(json) {
    return LawfirmCaseModelResFromJSONTyped(json, false);
}
export function LawfirmCaseModelResFromJSONTyped(json, ignoreDiscriminator) {
...
export function LawfirmCaseModelResToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export var LawfirmCaseModelResCaseDecisionStatusEnum;
(function (LawfirmCaseModelResCaseDecisionStatusEnum) {
...
* @enum {string}
*/
export var LawfirmCaseModelResRefundOwnerEnum;
(function (LawfirmCaseModelResRefundOwnerEnum) {
    LawfirmCaseModelResRefundOwnerEnum["LAWFIRM"] = "LAWFIRM";
    LawfirmCaseModelResRefundOwnerEnum["NONE"] = "NONE";
    LawfirmCaseModelResRefundOwnerEnum["OTR"] = "OTR";
})(LawfirmCaseModelResRefundOwnerEnum || (LawfirmCaseModelResRefundOwnerEnum = {}));
