...
export declare function MarkCaseAsResolvedResponseFromJSON(json: any): MarkCaseAsResolvedResponse;
export declare function MarkCaseAsResolvedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MarkCaseAsResolvedResponse;
export declare function MarkCaseAsResolvedResponseToJSON(value?: MarkCaseAsResolvedResponse | null): any;
/**
* @export
* @enum {string}
*/
