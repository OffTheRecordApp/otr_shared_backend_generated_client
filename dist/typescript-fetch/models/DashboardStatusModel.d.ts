...
export declare function DashboardStatusModelFromJSON(json: any): DashboardStatusModel;
export declare function DashboardStatusModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardStatusModel;
export declare function DashboardStatusModelToJSON(value?: DashboardStatusModel | null): any;
/**
* @export
* @enum {string}
*/
