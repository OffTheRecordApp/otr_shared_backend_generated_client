...
export declare function AccountLevelFeeToSaveFromJSON(json: any): AccountLevelFeeToSave;
export declare function AccountLevelFeeToSaveFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountLevelFeeToSave;
export declare function AccountLevelFeeToSaveToJSON(value?: AccountLevelFeeToSave | null): any;
/**
* @export
* @enum {string}
*/
