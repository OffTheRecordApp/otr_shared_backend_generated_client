...
export function EnableViolationModelFromJSON(json: any): EnableViolationModel {
    return EnableViolationModelFromJSONTyped(json, false);
}

export function EnableViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnableViolationModel {
...
export function EnableViolationModelToJSON(value?: EnableViolationModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
