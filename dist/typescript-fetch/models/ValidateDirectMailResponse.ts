...
export function ValidateDirectMailResponseFromJSON(json: any): ValidateDirectMailResponse {
    return ValidateDirectMailResponseFromJSONTyped(json, false);
}

export function ValidateDirectMailResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidateDirectMailResponse {
...
export function ValidateDirectMailResponseToJSON(value?: ValidateDirectMailResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
