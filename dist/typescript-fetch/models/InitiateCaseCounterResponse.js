...
export function InitiateCaseCounterResponseFromJSON(json) {
    return InitiateCaseCounterResponseFromJSONTyped(json, false);
}
export function InitiateCaseCounterResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function InitiateCaseCounterResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
