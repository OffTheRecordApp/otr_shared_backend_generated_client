 ...
 */
import { CountryRegion, TimestampRes } from './';
/**
 *
 * @export
...
export declare function CaseWithCoverageObtainedFromJSON(json: any): CaseWithCoverageObtained;
export declare function CaseWithCoverageObtainedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CaseWithCoverageObtained;
export declare function CaseWithCoverageObtainedToJSON(value?: CaseWithCoverageObtained | null): any;
/**
* @export
* @enum {string}
*/
