...
export function TicketTypeAttributeFromJSON(json: any): TicketTypeAttribute {
    return TicketTypeAttributeFromJSONTyped(json, false);
}

export function TicketTypeAttributeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TicketTypeAttribute {
...
export function TicketTypeAttributeToJSON(value?: TicketTypeAttribute | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
