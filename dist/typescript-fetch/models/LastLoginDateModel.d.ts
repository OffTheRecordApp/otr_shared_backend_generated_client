...
export declare function LastLoginDateModelFromJSON(json: any): LastLoginDateModel;
export declare function LastLoginDateModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): LastLoginDateModel;
export declare function LastLoginDateModelToJSON(value?: LastLoginDateModel | null): any;
/**
* @export
* @enum {string}
*/
