 ...
 *
 * @export
 * @interface CitationViolationModel
 */
export interface CitationViolationModel {
    /**
     *
     * @type {string}
     * @memberof CitationViolationModel
     */
     ...
     * @memberof CitationViolationModel
     */
    violationClassification?: CitationViolationModelViolationClassificationEnum;
    /**
     *
     * @type {string}
     * @memberof CitationViolationModel
...
export declare function CitationViolationModelFromJSON(json: any): CitationViolationModel;
export declare function CitationViolationModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): CitationViolationModel;
export declare function CitationViolationModelToJSON(value?: CitationViolationModel | null): any;
/**
* @export
* @enum {string}
*/
export declare enum CitationViolationModelViolationClassificationEnum {
