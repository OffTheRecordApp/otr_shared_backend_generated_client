...
export function AddCourtCoverageRequestFromJSON(json: any): AddCourtCoverageRequest {
    return AddCourtCoverageRequestFromJSONTyped(json, false);
}

export function AddCourtCoverageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddCourtCoverageRequest {
...
export function AddCourtCoverageRequestToJSON(value?: AddCourtCoverageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum AddCourtCoverageRequestClassificationEnum {
