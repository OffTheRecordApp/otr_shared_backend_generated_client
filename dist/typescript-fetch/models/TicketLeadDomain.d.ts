 ...
 */
import { CountryRegion, NoteEntity, TimestampRes } from './';
/**
 *
 * @export
...
export declare function TicketLeadDomainFromJSON(json: any): TicketLeadDomain;
export declare function TicketLeadDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): TicketLeadDomain;
export declare function TicketLeadDomainToJSON(value?: TicketLeadDomain | null): any;
/**
* @export
* @enum {string}
*/
