...
export function GetLawfirmCaseStatsResponseFromJSON(json: any): GetLawfirmCaseStatsResponse {
    return GetLawfirmCaseStatsResponseFromJSONTyped(json, false);
}

export function GetLawfirmCaseStatsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLawfirmCaseStatsResponse {
...
export function GetLawfirmCaseStatsResponseToJSON(value?: GetLawfirmCaseStatsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
