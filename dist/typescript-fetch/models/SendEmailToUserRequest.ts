...
export function SendEmailToUserRequestFromJSON(json: any): SendEmailToUserRequest {
    return SendEmailToUserRequestFromJSONTyped(json, false);
}

export function SendEmailToUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendEmailToUserRequest {
...
export function SendEmailToUserRequestToJSON(value?: SendEmailToUserRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
