...
export declare function GetLawfirmSummaryCaseRequestFromJSON(json: any): GetLawfirmSummaryCaseRequest;
export declare function GetLawfirmSummaryCaseRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLawfirmSummaryCaseRequest;
export declare function GetLawfirmSummaryCaseRequestToJSON(value?: GetLawfirmSummaryCaseRequest | null): any;
/**
* @export
* @enum {string}
*/
