...
export function CountyDomainFromJSON(json: any): CountyDomain {
    return CountyDomainFromJSONTyped(json, false);
}

export function CountyDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountyDomain {
...
export function CountyDomainToJSON(value?: CountyDomain | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
