...
export function AvailableRegionFromJSON(json) {
    return AvailableRegionFromJSONTyped(json, false);
}
export function AvailableRegionFromJSONTyped(json, ignoreDiscriminator) {
...
export function AvailableRegionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
