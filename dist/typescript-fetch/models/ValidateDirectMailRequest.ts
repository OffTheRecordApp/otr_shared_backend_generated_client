...
export function ValidateDirectMailRequestFromJSON(json: any): ValidateDirectMailRequest {
    return ValidateDirectMailRequestFromJSONTyped(json, false);
}

export function ValidateDirectMailRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidateDirectMailRequest {
...
export function ValidateDirectMailRequestToJSON(value?: ValidateDirectMailRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
