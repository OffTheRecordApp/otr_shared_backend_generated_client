...
export function MarkCaseAsResolvedResponseFromJSON(json: any): MarkCaseAsResolvedResponse {
    return MarkCaseAsResolvedResponseFromJSONTyped(json, false);
}

export function MarkCaseAsResolvedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MarkCaseAsResolvedResponse {
...
export function MarkCaseAsResolvedResponseToJSON(value?: MarkCaseAsResolvedResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
