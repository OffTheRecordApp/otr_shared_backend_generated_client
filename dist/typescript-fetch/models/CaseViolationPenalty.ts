...
export function CaseViolationPenaltyFromJSON(json: any): CaseViolationPenalty {
    return CaseViolationPenaltyFromJSONTyped(json, false);
}

export function CaseViolationPenaltyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CaseViolationPenalty {
...
export function CaseViolationPenaltyToJSON(value?: CaseViolationPenalty | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
