...
export function DefaultClassModelFromJSON(json: any): DefaultClassModel {
    return DefaultClassModelFromJSONTyped(json, false);
}

export function DefaultClassModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultClassModel {
...
export function DefaultClassModelToJSON(value?: DefaultClassModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
