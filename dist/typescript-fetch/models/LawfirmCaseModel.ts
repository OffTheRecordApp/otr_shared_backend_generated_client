...
export function LawfirmCaseModelFromJSON(json: any): LawfirmCaseModel {
    return LawfirmCaseModelFromJSONTyped(json, false);
}

export function LawfirmCaseModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): LawfirmCaseModel {
...
export function LawfirmCaseModelToJSON(value?: LawfirmCaseModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
* @enum {string}
*/
export enum LawfirmCaseModelCaseDecisionStatusEnum {
    ACCEPTED = 'ACCEPTED',
    CREATED = 'CREATED',
    DECLINED = 'DECLINED',
    EXPIRED = 'EXPIRED',
...
* @enum {string}
*/
export enum LawfirmCaseModelRefundOwnerEnum {
    LAWFIRM = 'LAWFIRM',
    NONE = 'NONE',
    OTR = 'OTR'
}
