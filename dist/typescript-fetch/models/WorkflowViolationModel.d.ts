...
export declare function WorkflowViolationModelToJSON(value?: WorkflowViolationModel | null): any;
/**
* @export
* @enum {string}
*/
export declare enum WorkflowViolationModelViolationClassificationEnum {
