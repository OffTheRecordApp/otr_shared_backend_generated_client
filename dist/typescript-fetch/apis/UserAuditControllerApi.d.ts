...
import { GetLastLoginResponse, ListUserAuditEventsByCursorResponse } from '../models';
 ...
 *
 */
export declare class UserAuditControllerApi extends runtime.BaseAPI {
    /**
     * getLastLogin
     */
    getLastLoginUsingGETRaw(requestParameters: GetLastLoginUsingGETRequest): Promise<runtime.ApiResponse<GetLastLoginResponse>>;
    /**
     * getLastLogin
     */
    getLastLoginUsingGET(requestParameters: GetLastLoginUsingGETRequest): Promise<GetLastLoginResponse>;
    /**
     * listUserAuditEventsByCursor
     */
    listUserAuditEventsByCursorUsingGETRaw(requestParameters: ListUserAuditEventsByCursorUsingGETRequest): Promise<runtime.ApiResponse<ListUserAuditEventsByCursorResponse>>;
    /**
     * listUserAuditEventsByCursor
     */
    listUserAuditEventsByCursorUsingGET(requestParameters: ListUserAuditEventsByCursorUsingGETRequest): Promise<ListUserAuditEventsByCursorResponse>;
}
/**
    * @export
    * @enum {string}
