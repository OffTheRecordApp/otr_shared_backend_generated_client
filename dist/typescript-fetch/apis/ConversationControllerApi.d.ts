...
export interface SendOverduePaymentReminderIfStillOwedUsingPOSTRequest {
    caseId: string;
    request: AddNewCaseMessageRequest;
}
...
export declare class ConversationControllerApi extends runtime.BaseAPI {
     ...
     */
    sendOverduePaymentReminderIfStillOwedUsingPOSTRaw(requestParameters: SendOverduePaymentReminderIfStillOwedUsingPOSTRequest): Promise<runtime.ApiResponse<void>>;
    /**
     * sendOverduePaymentReminderIfStillOwed
     */
    sendOverduePaymentReminderIfStillOwedUsingPOST(requestParameters: SendOverduePaymentReminderIfStillOwedUsingPOSTRequest): Promise<void>;
    /**
     * setFlagOnMessages
     */
