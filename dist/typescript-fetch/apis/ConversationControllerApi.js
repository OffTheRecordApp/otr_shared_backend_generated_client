...
export class ConversationControllerApi extends runtime.BaseAPI {
     ...
     */
    sendOverduePaymentReminderIfStillOwedUsingPOSTRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.caseId === null || requestParameters.caseId === undefined) {
                throw new runtime.RequiredError('caseId', 'Required parameter requestParameters.caseId was null or undefined when calling sendOverduePaymentReminderIfStillOwedUsingPOST.');
            }
            if (requestParameters.request === null || requestParameters.request === undefined) {
                throw new runtime.RequiredError('request', 'Required parameter requestParameters.request was null or undefined when calling sendOverduePaymentReminderIfStillOwedUsingPOST.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json';
            const response = yield this.request({
                path: `/api/v1/cases/{caseId}/overdue-payment-reminder`.replace(`{${"caseId"}}`, encodeURIComponent(String(requestParameters.caseId))),
                method: 'POST',
                headers: headerParameters,
                query: queryParameters,
                body: AddNewCaseMessageRequestToJSON(requestParameters.request),
     ...
     * sendOverduePaymentReminderIfStillOwed
     */
    sendOverduePaymentReminderIfStillOwedUsingPOST(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.sendOverduePaymentReminderIfStillOwedUsingPOSTRaw(requestParameters);
        });
    }
    /**
     * setFlagOnMessages
