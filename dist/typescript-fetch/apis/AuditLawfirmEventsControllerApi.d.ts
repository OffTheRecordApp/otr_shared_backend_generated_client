...
import { ListLawfirmAuditEventsByCursorResponse } from '../models';
 ...
 *
 */
export declare class AuditLawfirmEventsControllerApi extends runtime.BaseAPI {
    /**
     * listLawfirmAuditEventsByCursor
     */
    listLawfirmAuditEventsByCursorUsingGETRaw(requestParameters: ListLawfirmAuditEventsByCursorUsingGETRequest): Promise<runtime.ApiResponse<ListLawfirmAuditEventsByCursorResponse>>;
    /**
     * listLawfirmAuditEventsByCursor
     */
    listLawfirmAuditEventsByCursorUsingGET(requestParameters: ListLawfirmAuditEventsByCursorUsingGETRequest): Promise<ListLawfirmAuditEventsByCursorResponse>;
}
/**
    * @export
    * @enum {string}
    */
export declare enum ListLawfirmAuditEventsByCursorUsingGETExcludeTypesEnum {
    ...
    LAWFIRMSURCHARGEADDED = "LAWFIRM_SURCHARGE_ADDED",
    LAWFIRMSURCHARGEREMOVED = "LAWFIRM_SURCHARGE_REMOVED",
    LAWFIRMSURCHARGEUPDATED = "LAWFIRM_SURCHARGE_UPDATED",
...
/**
    ...
    * @enum {string}
    */
export declare enum ListLawfirmAuditEventsByCursorUsingGETIncludeTypesEnum {
    ACCOUNTCOVERAGEADDED = "ACCOUNT_COVERAGE_ADDED",
    ACCOUNTCOVERAGEREMOVED = "ACCOUNT_COVERAGE_REMOVED",
    ACCOUNTMANAGERCHANGED = "ACCOUNT_MANAGER_CHANGED",
    ACCOUNTNOTIFICATIONSTATUSCHANGED = "ACCOUNT_NOTIFICATION_STATUS_CHANGED",
