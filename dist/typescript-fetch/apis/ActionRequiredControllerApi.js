...
import { ClientActionRequiredRequestToJSON, } from '../models';
/**
 *
 */
export class ActionRequiredControllerApi extends runtime.BaseAPI {
     ...
     */
    notifyClientActionRequirementUsingPOSTRaw(requestParameters) {
     ...
     * notifyClientActionRequirement
     */
    notifyClientActionRequirementUsingPOST(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.notifyClientActionRequirementUsingPOSTRaw(requestParameters);
        });
    }
}
