...
export class CaseResolutionControllerApi extends runtime.BaseAPI {
     ...
     */
    addSocialMediaActionUsingPOSTRaw(requestParameters) {
     ...
     * addSocialMediaAction
     */
    addSocialMediaActionUsingPOST(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.addSocialMediaActionUsingPOSTRaw(requestParameters);
        });
    }
}
