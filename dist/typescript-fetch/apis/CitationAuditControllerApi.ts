...
import {
    ...
    ListCitationAuditEventsResponseFromJSON,
    ListCitationAuditEventsResponseToJSON,
} from '../models';
...
export class CitationAuditControllerApi extends runtime.BaseAPI {
     ...
     */
    async listCitationAuditEventsUsingGETRaw(requestParameters: ListCitationAuditEventsUsingGETRequest): Promise<runtime.ApiResponse<ListCitationAuditEventsResponse>> {
     ...
     * listCitationAuditEvents
     */
    async listCitationAuditEventsUsingGET(requestParameters: ListCitationAuditEventsUsingGETRequest): Promise<ListCitationAuditEventsResponse> {
        const response = await this.listCitationAuditEventsUsingGETRaw(requestParameters);
...
/**
    ...
    * @enum {string}
    */
export enum ListCitationAuditEventsUsingGETExcludeTypesEnum {
...
/**
    ...
    * @enum {string}
    */
export enum ListCitationAuditEventsUsingGETIncludeTypesEnum {
    ACCOUNTCOVERAGEADDED = 'ACCOUNT_COVERAGE_ADDED',
    ACCOUNTCOVERAGEREMOVED = 'ACCOUNT_COVERAGE_REMOVED',
    ACCOUNTNOTIFICATIONSTATUSCHANGED = 'ACCOUNT_NOTIFICATION_STATUS_CHANGED',
    ACCOUNTSTATUSCHANGED = 'ACCOUNT_STATUS_CHANGED',
