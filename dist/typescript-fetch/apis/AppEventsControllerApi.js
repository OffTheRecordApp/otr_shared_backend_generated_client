...
import { AppEventCreateRequestToJSON, } from '../models';
/**
 *
 */
export class AppEventsControllerApi extends runtime.BaseAPI {
     ...
     * addAppEvent
     */
    addAppEventUsingPOSTRaw(requestParameters) {
     ...
     * addAppEvent
     */
    addAppEventUsingPOST(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.addAppEventUsingPOSTRaw(requestParameters);
