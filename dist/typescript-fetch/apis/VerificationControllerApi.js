...
import { GetInviteByTokenResponseFromJSON, } from '../models';
/**
 *
 */
export class VerificationControllerApi extends runtime.BaseAPI {
     ...
     * getInviteByToken
     */
    getInviteByTokenUsingGETRaw(requestParameters) {
     ...
     * getInviteByToken
     */
    getInviteByTokenUsingGET(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getInviteByTokenUsingGETRaw(requestParameters);
