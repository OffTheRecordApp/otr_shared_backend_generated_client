...
import { SignRecordingUrlRequestToJSON, SignRecordingUrlResponseFromJSON, } from '../models';
/**
 *
 */
export class FreshcallerControllerApi extends runtime.BaseAPI {
     ...
     * signRecordingUrl
     */
    signRecordingUrlUsingPOSTRaw(requestParameters) {
     ...
     * signRecordingUrl
     */
    signRecordingUrlUsingPOST(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.signRecordingUrlUsingPOSTRaw(requestParameters);
