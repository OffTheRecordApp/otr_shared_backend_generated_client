...
export class ListCasesControllerApi {
     ...
     */
    public listDashboardCasesUsingGET (userId: number, limit?: number, previousPageToken?: string, sortBy?: 'BOOKING_CONFIRMED_DATE' | 'CITATION_ISSUE_DATE', statusCategories?: Array<'ACTIVE' | 'CANCELLED' | 'RESOLVED' | 'UNCONFIRMED'>, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ListDashboardCasesResponse> {
