...
export class CaseStatusControllerApi {
     ...
     */
    public getCaseStatusesUsingGET (categories?: Array<'ACTIVE' | 'CANCELLED' | 'RESOLVED' | 'UNCONFIRMED'>, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.CaseStatusDetailsResponse>> {
