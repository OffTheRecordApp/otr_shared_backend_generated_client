...
angular.module('otrBackendService', [])
    .factory('OtrService', ['$q', '$http', '$rootScope', function($q, $http, $rootScope) {
        ...
        var OtrService = (function() {
             ...
             * 
             * @method
             * @name OtrService#createRefLinksForAllUsersUsingPOST
             * 
             */
            OtrService.prototype.createRefLinksForAllUsersUsingPOST = function(parameters) {
                ...
                var path = '/api/v1/admin/tools/createRefLinksForAllUsers';
             ...
             * @param {string} caseId - caseId
             * @param {} postNewCaseMessageRequest - postNewCaseMessageRequest
             * 
             */
            OtrService.prototype.addMessageToConversationUsingPOST = function(parameters) {
                ...
                if (parameters['postNewCaseMessageRequest'] !== undefined) {
                    body = parameters['postNewCaseMessageRequest'];
                }

                if (parameters['postNewCaseMessageRequest'] === undefined) {
                    deferred.reject(new Error('Missing required  parameter: postNewCaseMessageRequest'));
                    return deferred.promise;
                }
             ...
             * 
             * @method
             * @name OtrService#listConfirmedCasesNotAcceptedUsingGET
             * 
             */
            OtrService.prototype.listConfirmedCasesNotAcceptedUsingGET = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                ...
                var domain = this.domain;
                var path = '/api/v1/console/cases/confirmed';
             ...
             * 
             * @method
             * @name OtrService#getAllCourtsUsingGET
             * 
             */
            OtrService.prototype.getAllCourtsUsingGET = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
            ...
            OtrService.prototype.getLawfirmTransactionsUsingGET = function(parameters) {
                ...
                var domain = this.domain;
                var path = '/api/v1/lawfirms/{lawfirmIdString}/transactions';
