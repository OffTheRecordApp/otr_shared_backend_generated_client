...
angular.module('otrBackendService', [])
    .factory('OtrService', ['$q', '$http', '$rootScope', function($q, $http, $rootScope) {
        ...
        var OtrService = (function() {
             ...
             * @param {} parameters.request - request
             */
            OtrService.prototype.refundApplicationFeeUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/application-fee/{lawfirmFeeId}/refund';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * testTransaction
             * @method
             * @name OtrService#testTransactionUsingPUT
             * @param {object} parameters - method options and parameters
             * @param {string} parameters.citationId - citationId
             */
            OtrService.prototype.testTransactionUsingPUT = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/citations/{citationId}/test-trans';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * getFoo
             * @method
             * @name OtrService#getFooUsingGET
             * @param {object} parameters - method options and parameters
             * @param {integer} parameters.lawfirmId - lawfirmId
             */
            OtrService.prototype.getFooUsingGET = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/lawfirms/{lawfirmId}/foo';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
