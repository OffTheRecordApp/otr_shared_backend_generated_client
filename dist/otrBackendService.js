...
angular.module('otrBackendService', [])
    .factory('OtrService', ['$q', '$http', '$rootScope', function($q, $http, $rootScope) {
        ...
        var OtrService = (function() {
             ...
             * 
             */
            OtrService.prototype.addToEmailBlackListUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
             ...
             * 
             */
            OtrService.prototype.refundChargeToClientUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
             ...
             * 
             * @method
             * @name OtrService#createNewCitationV2UsingPOST
             * @param {} request - request
             * 
             */
            OtrService.prototype.createNewCitationV2UsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
