...
angular.module('otrBackendService', [])
    .factory('OtrService', ['$q', '$http', '$rootScope', function($q, $http, $rootScope) {
        ...
        var OtrService = (function() {
             ...
             * @method
             * @name OtrService#sendOverduePaymentReminderIfStillOwedUsingPOST
             * @param {object} parameters - method options and parameters
             * @param {string} parameters.caseId - caseId
             * @param {} parameters.request - request
             */
            OtrService.prototype.sendOverduePaymentReminderIfStillOwedUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/cases/{caseId}/overdue-payment-reminder';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * @method
             * @name OtrService#saveLawfirmAccountManagerUsingPOST
             * @param {object} parameters - method options and parameters
             * @param {integer} parameters.lawfirmId - lawfirmId
             * @param {} parameters.request - request
             */
            OtrService.prototype.saveLawfirmAccountManagerUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/lawfirms/{lawfirmId}/account-manager';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * @method
             * @name OtrService#getAcceptedCaseBreakdownUsingGET
             * @param {object} parameters - method options and parameters
             * @param {integer} parameters.lawfirmId - lawfirmId
             */
            OtrService.prototype.getAcceptedCaseBreakdownUsingGET = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/lawfirms/{lawfirmId}/cases/accepted-breakdown';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * getLeadSummary
             * @method
             * @name OtrService#getLeadSummaryUsingGET
             * @param {object} parameters - method options and parameters
             * @param {string} parameters.endDate - endDate
             * @param {integer} parameters.lawfirmId - lawfirmId
             * @param {string} parameters.startDate - startDate
             */
            OtrService.prototype.getLeadSummaryUsingGET = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/lawfirms/{lawfirmId}/cases/lead-summary';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * @method
             * @name OtrService#saveDefaultFeeRefundEligibilityUsingPOST
             * @param {object} parameters - method options and parameters
             * @param {integer} parameters.lawfirmId - lawfirmId
             * @param {} parameters.request - request
             */
            OtrService.prototype.saveDefaultFeeRefundEligibilityUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
                var domain = this.domain,
                    path = '/api/v1/lawfirms/{lawfirmId}/coverage/refund-eligibility';
                var body = {},
                    queryParameters = {},
                    headers = {},
                    form = {};
             ...
             * @method
             * @name OtrService#saveLawfirmSupportedStateUsingPOST
             * @param {object} parameters - method options and parameters
             * @param {integer} parameters.lawfirmId - lawfirmId
             * @param {} parameters.request - request
             */
            OtrService.prototype.saveLawfirmSupportedStateUsingPOST = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
