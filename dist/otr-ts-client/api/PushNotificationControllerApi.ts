...
export class PushNotificationControllerApi {
     ...
     */
    public pushCaseMessageUsingPOST (caseId: string, pushRequest: models.PushNotificationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param pushRequest pushRequest
     */
    public pushNotificationToUserUsingPOST (recipientId: string, pushRequest: models.PushNotificationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public registerUsingPOST (request: models.PushNotificationRegistrationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
