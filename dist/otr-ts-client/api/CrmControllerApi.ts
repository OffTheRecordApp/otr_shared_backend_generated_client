...
export class CrmControllerApi {
     ...
     * @param request request
     */
    public replyToTicketUsingPOST (ticketId: string, request: models.ReplyToTicketRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public sendConsolidatedEmailToUserUsingPOST (request: models.SendConsolidatedEmailToUser, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
