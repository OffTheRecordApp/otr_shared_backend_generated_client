...
export class CitationControllerApi {
     ...
     */
    public assignCitationOwnerUsingPOST (citationId: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public dismissCitationsFromContactListUsingPOST (request: models.DismissCitationsFromContactListRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     */
    public setCitationContactListFlagUsingPOST (citationIdString: string, isDismissed: boolean, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     */
    public updateCitationUsingPUT (citationIdString: string, updateCitationRequest: models.UpdateCitationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
        const localVarPath = this.basePath + '/api/v1/citations/{citationIdString}'
            .replace('{' + 'citationIdString' + '}', encodeURIComponent(String(citationIdString)));
