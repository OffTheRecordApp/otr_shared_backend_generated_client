...
export class LawfirmDocumentControllerApi {
     ...
     */
    public generateDocUsingPOST (lawfirmId: string, docType: models.'ENGAGEMENT_LETTER' | 'OTHER_IMAGE', request?: models.GetDocumentsRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentResponse> {
     ...
     * @param docType docType
     */
    public getDocumentUsingGET (lawfirmId: string, docType: models.'ENGAGEMENT_LETTER' | 'OTHER_IMAGE', extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentTemplateResponse> {
        const localVarPath = this.basePath + '/api/v1/lawfirms/{lawfirmId}/documents'
            .replace('{' + 'lawfirmId' + '}', encodeURIComponent(String(lawfirmId)));
     ...
     * @param request request
     */
    public previewDocUsingPOST (lawfirmId: string, docType: models.'ENGAGEMENT_LETTER' | 'OTHER_IMAGE', request: models.PreviewDocumentRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.LawfirmDocumentResponse> {
