...
export class ConsoleListControllerApi {
    ...
    /**
     * 
     * @summary getCasesWithUncapturedCharges
     * @param request request
     */
    public getCasesWithUncapturedChargesUsingPOST (request: models.GetCasesWithUncapturedChargesRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetCasesWithUncapturedChargesResponse> {
        ...
        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling getCasesWithUncapturedChargesUsingPOST.');
        }
     ...
     * @param request request
     */
    public getInvalidCasesWithStripeChargeUsingPOST (request: models.GetInvalidCasesWithStripeChargeRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetInvalidCasesWithStripeChargeResponse> {
     ...
     * @param request request
     */
    public getPendingAndRefusedCasesUsingPOST (request: models.GetPendingAndRefusedCasesRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetPendingAndRefusedCasesResponse> {
