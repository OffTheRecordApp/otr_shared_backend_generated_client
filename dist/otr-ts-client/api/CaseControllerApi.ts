...
export class CaseControllerApi {
     ...
     */
    public addViolationsToCitationUsingPOST (caseId: string, request: models.AddViolationsToCitationRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param codeId codeId
     */
    public applyReferralCodeUsingPOST (caseId: string, codeId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetCaseResponse> {
     ...
     * @param userId userId
     */
    public assignCaseToUserUsingPOST (caseId: string, userId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param caseId caseId
     */
    public assignOwnerUsingPOST (caseId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param caseId caseId
     */
    public confirmBookingUsingPOST (caseId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.GetCaseResponse> {
        const localVarPath = this.basePath + '/api/v1/cases/{caseId}'
            .replace('{' + 'caseId' + '}', encodeURIComponent(String(caseId)));
        ...
        // verify required parameter 'caseId' is not null or undefined
        if (caseId === null || caseId === undefined) {
            throw new Error('Required parameter caseId was null or undefined when calling confirmBookingUsingPOST.');
        }
     ...
     */
    public getCaseFromCitationUsingGET (citationId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param caseId caseId
     */
    public getCaseNotesUsingGET (caseId: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public markCaseAsResolvedUsingPOST (caseId: string, request: models.MarkCaseAsResolvedRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     */
    public removeViolationsFromCitationUsingDELETE (caseId: string, violationTypes: Array<number>, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public saveCaseNotesUsingPOST (caseId: string, request: models.SaveCaseNotesRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
        const localVarPath = this.basePath + '/api/v1/cases/{caseId}/notes'
            .replace('{' + 'caseId' + '}', encodeURIComponent(String(caseId)));
     ...
     * @param request request
     */
    public setCourtDateForCaseUsingPOST (caseId: string, request: models.SetCourtDateForCaseRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
     ...
     * @param request request
     */
    public updateDeclineTicketsUsingPUT (caseId: string, request: models.UpdateCaseDeclineTicketsRequest, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
