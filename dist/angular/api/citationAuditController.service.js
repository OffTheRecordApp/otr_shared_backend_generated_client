...
exports.CitationAuditControllerService = void 0;
...
var CitationAuditControllerService = /** @class */ (function () {
    function CitationAuditControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CitationAuditControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CitationAuditControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CitationAuditControllerService.prototype.listCitationAuditEventsUsingGET = function (citationId, excludeTypes, includeTypes, limit, nextPageToken, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/citations/" + this.configuration.encodeParam({ name: "citationId", value: citationId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }) + "/audit-events";
    ...
    CitationAuditControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], CitationAuditControllerService);
    return CitationAuditControllerService;
}());
exports.CitationAuditControllerService = CitationAuditControllerService;
