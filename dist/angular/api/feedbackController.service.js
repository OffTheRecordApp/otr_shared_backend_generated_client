...
exports.FeedbackControllerService = void 0;
...
var FeedbackControllerService = /** @class */ (function () {
    function FeedbackControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    FeedbackControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    FeedbackControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    FeedbackControllerService.prototype.postFeedbackUsingPOST = function (request, isReview, observe, reportProgress, options) {
        ...
        if (isReview !== undefined && isReview !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, isReview, 'isReview');
        }
        ...
        var localVarPath = "/api/v1/feedback";
    ...
    FeedbackControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return FeedbackControllerService;
}());
exports.FeedbackControllerService = FeedbackControllerService;
