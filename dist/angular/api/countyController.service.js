...
exports.CountyControllerService = void 0;
...
var CountyControllerService = /** @class */ (function () {
    function CountyControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CountyControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CountyControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CountyControllerService.prototype.getCountiesUsingGET = function (state, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/counties";
    ...
    CountyControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CountyControllerService;
}());
exports.CountyControllerService = CountyControllerService;
