...
exports.LawfirmRatesControllerService = void 0;
...
var LawfirmRatesControllerService = /** @class */ (function () {
    function LawfirmRatesControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmRatesControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmRatesControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmRatesControllerService.prototype.getActiveRatesByAreaUsingPOST = function (request, observe, reportProgress, options) {
    ...
    LawfirmRatesControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return LawfirmRatesControllerService;
}());
exports.LawfirmRatesControllerService = LawfirmRatesControllerService;
