...
exports.ConfigurationControllerService = void 0;
...
var ConfigurationControllerService = /** @class */ (function () {
    function ConfigurationControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ConfigurationControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ConfigurationControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ConfigurationControllerService.prototype.getAppConfigurationUsingGET = function (observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/config/app";
    ...
    ConfigurationControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return ConfigurationControllerService;
}());
exports.ConfigurationControllerService = ConfigurationControllerService;
