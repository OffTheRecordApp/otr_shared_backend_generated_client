...
exports.CaseCreationControllerService = void 0;
...
var CaseCreationControllerService = /** @class */ (function () {
    function CaseCreationControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CaseCreationControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CaseCreationControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CaseCreationControllerService.prototype.addSampleCaseUsingPUT = function (lawfirmId, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/citations/".concat(this.configuration.encodeParam({ name: "lawfirmId", value: lawfirmId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/sample");
    ...
    CaseCreationControllerService.prototype.matchCaseUsingPOST = function (citationIdString, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/citations/".concat(this.configuration.encodeParam({ name: "citationIdString", value: citationIdString, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/case");
    ...
    CaseCreationControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CaseCreationControllerService;
}());
exports.CaseCreationControllerService = CaseCreationControllerService;
