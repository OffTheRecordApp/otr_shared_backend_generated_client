...
exports.LawfirmStorefrontControllerService = void 0;
...
var LawfirmStorefrontControllerService = /** @class */ (function () {
    function LawfirmStorefrontControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmStorefrontControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmStorefrontControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmStorefrontControllerService.prototype.listLawfirmStorefrontsUsingGET = function (page, regionCode, size, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/lawfirm-storefronts";
    ...
    LawfirmStorefrontControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], LawfirmStorefrontControllerService);
    return LawfirmStorefrontControllerService;
}());
exports.LawfirmStorefrontControllerService = LawfirmStorefrontControllerService;
