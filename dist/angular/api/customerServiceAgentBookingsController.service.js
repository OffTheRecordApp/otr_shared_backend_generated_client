...
exports.CustomerServiceAgentBookingsControllerService = void 0;
...
var CustomerServiceAgentBookingsControllerService = /** @class */ (function () {
    function CustomerServiceAgentBookingsControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CustomerServiceAgentBookingsControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CustomerServiceAgentBookingsControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CustomerServiceAgentBookingsControllerService.prototype.listAgentBookingsUsingGET = function (agentUserId, caseStatus, channel, direction, endDate, length, offset, sortBy, sortOrder, startDate, state, timeZoneId, observe, reportProgress, options) {
        ...
        if (agentUserId !== undefined && agentUserId !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, agentUserId, 'agentUserId');
        }
        if (caseStatus !== undefined && caseStatus !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, caseStatus, 'caseStatus');
        }
        if (channel !== undefined && channel !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, channel, 'channel');
        }
        ...
        if (sortOrder !== undefined && sortOrder !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, sortOrder, 'sortOrder');
        }
        ...
        if (timeZoneId !== undefined && timeZoneId !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, timeZoneId, 'timeZoneId');
        }
        ...
        var localVarPath = "/api/v1/cs-agent-bookings";
    ...
    CustomerServiceAgentBookingsControllerService.prototype.saveAgentBookingUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    CustomerServiceAgentBookingsControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CustomerServiceAgentBookingsControllerService;
}());
exports.CustomerServiceAgentBookingsControllerService = CustomerServiceAgentBookingsControllerService;
