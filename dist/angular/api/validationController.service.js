...
exports.ValidationControllerService = void 0;
...
var ValidationControllerService = /** @class */ (function () {
    function ValidationControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ValidationControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ValidationControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ValidationControllerService.prototype.validateEmailAddressUsingGET = function (email, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/validate/email";
    ...
    ValidationControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return ValidationControllerService;
}());
exports.ValidationControllerService = ValidationControllerService;
