...
exports.UtilityControllerService = void 0;
...
var UtilityControllerService = /** @class */ (function () {
    function UtilityControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    UtilityControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    UtilityControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    UtilityControllerService.prototype.backfillLawfirmTransactionRecordsUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/utility/backfill-lawfirm-transaction-records";
    ...
    UtilityControllerService.prototype.getStatusUsingGET = function (observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        var localVarPath = "/api/v1/utility/status";
    ...
    UtilityControllerService.prototype.setStatusUsingPOST = function (lawfirmTransactionsStatus, syncStatus, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        if (lawfirmTransactionsStatus !== undefined && lawfirmTransactionsStatus !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, lawfirmTransactionsStatus, 'lawfirmTransactionsStatus');
        }
        if (syncStatus !== undefined && syncStatus !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, syncStatus, 'syncStatus');
        }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        if (localVarHttpHeaderAcceptSelected === undefined) {
    ...
    UtilityControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return UtilityControllerService;
}());
exports.UtilityControllerService = UtilityControllerService;
