...
exports.CustomerLeadControllerService = void 0;
...
var CustomerLeadControllerService = /** @class */ (function () {
    function CustomerLeadControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CustomerLeadControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CustomerLeadControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CustomerLeadControllerService.prototype.postCustomerLeadUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/customer-leads";
    ...
    CustomerLeadControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CustomerLeadControllerService;
}());
exports.CustomerLeadControllerService = CustomerLeadControllerService;
