...
exports.OneTimePasswordControllerService = void 0;
...
var OneTimePasswordControllerService = /** @class */ (function () {
    function OneTimePasswordControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    OneTimePasswordControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    OneTimePasswordControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    OneTimePasswordControllerService.prototype.sendOneTimePasswordUsingPOST = function (observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/one_time_password";
    ...
    OneTimePasswordControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return OneTimePasswordControllerService;
}());
exports.OneTimePasswordControllerService = OneTimePasswordControllerService;
