...
exports.LawfirmCaseDecisionControllerService = void 0;
...
var LawfirmCaseDecisionControllerService = /** @class */ (function () {
    function LawfirmCaseDecisionControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmCaseDecisionControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmCaseDecisionControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmCaseDecisionControllerService.prototype.setLawfirmCaseDecisionUsingPOST = function (caseId, request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/lawfirm/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/decision");
    ...
    LawfirmCaseDecisionControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return LawfirmCaseDecisionControllerService;
}());
exports.LawfirmCaseDecisionControllerService = LawfirmCaseDecisionControllerService;
