...
exports.ViolationPenaltyControllerService = void 0;
...
var ViolationPenaltyControllerService = /** @class */ (function () {
    function ViolationPenaltyControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ViolationPenaltyControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ViolationPenaltyControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ViolationPenaltyControllerService.prototype.getPenaltiesByViolationUsingGET = function (violationId, flavor, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/violations/".concat(this.configuration.encodeParam({ name: "violationId", value: violationId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/penalties");
    ...
    ViolationPenaltyControllerService.prototype.getPenaltyTypesUsingGET = function (observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        var localVarPath = "/api/v1/violations/penalties";
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            responseType: responseType_,
            withCredentials: this.configuration.withCredentials,
    ...
    ViolationPenaltyControllerService.prototype.removePenaltyUsingDELETE = function (penaltyTypeId, violationId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/violations/".concat(this.configuration.encodeParam({ name: "violationId", value: violationId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/penalties/").concat(this.configuration.encodeParam({ name: "penaltyTypeId", value: penaltyTypeId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }));
    ...
    ViolationPenaltyControllerService.prototype.upsertPenaltyUsingPOST = function (violationId, penaltyToAdd, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (violationId === null || violationId === undefined) {
    ...
    ViolationPenaltyControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return ViolationPenaltyControllerService;
}());
exports.ViolationPenaltyControllerService = ViolationPenaltyControllerService;
