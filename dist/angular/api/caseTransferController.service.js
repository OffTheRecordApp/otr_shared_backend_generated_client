...
exports.CaseTransferControllerService = void 0;
...
var CaseTransferControllerService = /** @class */ (function () {
    function CaseTransferControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CaseTransferControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CaseTransferControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CaseTransferControllerService.prototype.getTransferHistoryUsingGET = function (caseId, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/transfer");
    ...
    CaseTransferControllerService.prototype.transferCaseUsingPUT = function (caseId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
    ...
    CaseTransferControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CaseTransferControllerService;
}());
exports.CaseTransferControllerService = CaseTransferControllerService;
