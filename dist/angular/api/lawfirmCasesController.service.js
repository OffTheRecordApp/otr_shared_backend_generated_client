...
exports.LawfirmCasesControllerService = void 0;
...
var LawfirmCasesControllerService = /** @class */ (function () {
    function LawfirmCasesControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmCasesControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmCasesControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmCasesControllerService.prototype.getLawfirmCasesByPageUsingPOST = function (lawfirmIdString, request, courtDateFilter, end, hasPaymentPlan, length, page, start, observe, reportProgress, options) {
        ...
        if (hasPaymentPlan !== undefined && hasPaymentPlan !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, hasPaymentPlan, 'hasPaymentPlan');
        }
        ...
        var localVarPath = "/api/v2/lawfirm/".concat(this.configuration.encodeParam({ name: "lawfirmIdString", value: lawfirmIdString, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/cases");
    ...
    LawfirmCasesControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return LawfirmCasesControllerService;
}());
exports.LawfirmCasesControllerService = LawfirmCasesControllerService;
