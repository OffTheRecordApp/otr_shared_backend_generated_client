...
exports.CaseRefundControllerService = void 0;
...
var CaseRefundControllerService = /** @class */ (function () {
    function CaseRefundControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CaseRefundControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CaseRefundControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CaseRefundControllerService.prototype.cancelCaseUsingDELETE = function (request, observe, reportProgress, options) {
    ...
    CaseRefundControllerService.prototype.refundCasePaymentUsingPOST = function (caseId, casePaymentId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    CaseRefundControllerService.prototype.releasePaymentUsingPOST = function (caseId, casePaymentId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
    ...
    CaseRefundControllerService.prototype.updateRefundEligibilityForCaseUsingPUT = function (caseId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/refund-eligibility");
    ...
    CaseRefundControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], CaseRefundControllerService);
    return CaseRefundControllerService;
}());
exports.CaseRefundControllerService = CaseRefundControllerService;
