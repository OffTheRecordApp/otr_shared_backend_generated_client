...
exports.ReferralControllerService = void 0;
...
var ReferralControllerService = /** @class */ (function () {
    function ReferralControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ReferralControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ReferralControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ReferralControllerService.prototype.getReferralHistoryUsingGET = function (observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/referrals";
    ...
    ReferralControllerService.prototype.listReferralsUsingGET = function (userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v2/referrals";
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
    ...
    ReferralControllerService.prototype.publishReferralContactsUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/referrals/contacts";
    ...
    ReferralControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return ReferralControllerService;
}());
exports.ReferralControllerService = ReferralControllerService;
