...
exports.AppEventsControllerService = void 0;
...
var AppEventsControllerService = /** @class */ (function () {
    function AppEventsControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    AppEventsControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    AppEventsControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    AppEventsControllerService.prototype.addAppEventUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/app-events";
    ...
    AppEventsControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return AppEventsControllerService;
}());
exports.AppEventsControllerService = AppEventsControllerService;
