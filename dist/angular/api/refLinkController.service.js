...
exports.RefLinkControllerService = void 0;
...
var RefLinkControllerService = /** @class */ (function () {
    function RefLinkControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    RefLinkControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    RefLinkControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    RefLinkControllerService.prototype.getRefLinksForUserUsingGET = function (userIdString, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/reflinks/".concat(this.configuration.encodeParam({ name: "userIdString", value: userIdString, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }));
    ...
    RefLinkControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return RefLinkControllerService;
}());
exports.RefLinkControllerService = RefLinkControllerService;
