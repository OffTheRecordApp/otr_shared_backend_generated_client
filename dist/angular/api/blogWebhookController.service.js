...
exports.BlogWebhookControllerService = void 0;
...
var BlogWebhookControllerService = /** @class */ (function () {
    function BlogWebhookControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    BlogWebhookControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    BlogWebhookControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    BlogWebhookControllerService.prototype.handleEventUsingPOST = function (event, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/webhooks/prismic";
    ...
    BlogWebhookControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], BlogWebhookControllerService);
    return BlogWebhookControllerService;
}());
exports.BlogWebhookControllerService = BlogWebhookControllerService;
