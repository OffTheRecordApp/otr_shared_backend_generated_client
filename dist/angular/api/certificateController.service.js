...
exports.CertificateControllerService = void 0;
...
var CertificateControllerService = /** @class */ (function () {
    function CertificateControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CertificateControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CertificateControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CertificateControllerService.prototype.getSSLPublicCertFileUsingGET = function (encoding, observe, reportProgress, options) {
        ...
        if (encoding !== undefined && encoding !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, encoding, 'encoding');
        }
        ...
        var localVarPath = "/api/v1/certificates/ssl";
    ...
    CertificateControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CertificateControllerService;
}());
exports.CertificateControllerService = CertificateControllerService;
