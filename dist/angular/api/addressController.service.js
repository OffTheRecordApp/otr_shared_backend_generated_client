...
exports.AddressControllerService = void 0;
...
var AddressControllerService = /** @class */ (function () {
    function AddressControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    AddressControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    AddressControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    AddressControllerService.prototype.getCountryListUsingGET = function (observe, reportProgress, options) {
    ...
    AddressControllerService.prototype.getCountryRegionsUsingGET = function (countryCode, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/countries/".concat(this.configuration.encodeParam({ name: "countryCode", value: countryCode, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/regions");
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            responseType: responseType_,
            withCredentials: this.configuration.withCredentials,
    ...
    AddressControllerService.prototype.getLocationUsingGET = function (zipCode, countryCode, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    AddressControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return AddressControllerService;
}());
exports.AddressControllerService = AddressControllerService;
