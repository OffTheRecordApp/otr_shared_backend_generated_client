...
exports.StripeControllerService = void 0;
...
var StripeControllerService = /** @class */ (function () {
    function StripeControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    StripeControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    StripeControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    StripeControllerService.prototype.connectStripeAccountUsingPOST = function (code, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/stripe/connect";
    ...
    StripeControllerService.prototype.createConnectAccountLinkUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/stripe/account/link";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    StripeControllerService.prototype.createStripeConnectAccountUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/stripe/account";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    StripeControllerService.prototype.handleOrphanedStripeChargesUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/stripe/handle-orphaned-stripe-charges";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    StripeControllerService.prototype.updateDisputeUsingPUT = function (disputeId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/stripe/disputes/".concat(this.configuration.encodeParam({ name: "disputeId", value: disputeId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }));
    ...
    StripeControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return StripeControllerService;
}());
exports.StripeControllerService = StripeControllerService;
