...
export class UserSearchControllerService {
     ...
     */
    public findMatchingUsersUsingPOST(request: FindMatchingUsersRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<FindMatchingUsersResponse>;
    public findMatchingUsersUsingPOST(request: FindMatchingUsersRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<FindMatchingUsersResponse>>;
    public findMatchingUsersUsingPOST(request: FindMatchingUsersRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<FindMatchingUsersResponse>>;
    public findMatchingUsersUsingPOST(request: FindMatchingUsersRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<FindMatchingUsersResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
