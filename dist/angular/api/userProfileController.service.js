...
exports.UserProfileControllerService = void 0;
...
var UserProfileControllerService = /** @class */ (function () {
    function UserProfileControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    UserProfileControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    UserProfileControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    UserProfileControllerService.prototype.addUserAddressUsingPOST = function (userId, request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/users/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/addresses");
    ...
    UserProfileControllerService.prototype.addUserPhoneNumberUsingPOST = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/users/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/phone-numbers");
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    UserProfileControllerService.prototype.deleteUserPhoneNumberUsingDELETE = function (phoneNumberId, userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    UserProfileControllerService.prototype.getUserAddressesUsingGET = function (userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
    ...
    UserProfileControllerService.prototype.mergeUserUsingPOST = function (primaryUserId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/users/".concat(this.configuration.encodeParam({ name: "primaryUserId", value: primaryUserId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/merge");
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    UserProfileControllerService.prototype.updateProfilePictureUsingPUT = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/users/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/profile-picture");
    ...
    UserProfileControllerService.prototype.updateUserAddressUsingPUT = function (addressId, userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    UserProfileControllerService.prototype.updateUserPhoneNumberUsingPUT = function (phoneNumberId, userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (phoneNumberId === null || phoneNumberId === undefined) {
    ...
    UserProfileControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return UserProfileControllerService;
}());
exports.UserProfileControllerService = UserProfileControllerService;
