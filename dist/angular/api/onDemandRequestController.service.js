...
exports.OnDemandRequestControllerService = void 0;
...
var OnDemandRequestControllerService = /** @class */ (function () {
    function OnDemandRequestControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    OnDemandRequestControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    OnDemandRequestControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    OnDemandRequestControllerService.prototype.requestLawyerUsingPOST = function (caseId, lawyerRequest, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/request");
    ...
    OnDemandRequestControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return OnDemandRequestControllerService;
}());
exports.OnDemandRequestControllerService = OnDemandRequestControllerService;
