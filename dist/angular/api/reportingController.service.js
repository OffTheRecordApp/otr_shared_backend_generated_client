...
exports.ReportingControllerService = void 0;
...
var ReportingControllerService = /** @class */ (function () {
    ...
    // @ts-ignore
    ReportingControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ReportingControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ReportingControllerService.prototype.getCourtCoverageForCountyReportUsingGET = function (countyId, regionCode, urWindowInDays, observe, reportProgress, options) {
        ...
        if (urWindowInDays !== undefined && urWindowInDays !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, urWindowInDays, 'urWindowInDays');
        }
        ...
        var localVarPath = "/api/v1/reports/court-coverage/".concat(this.configuration.encodeParam({ name: "regionCode", value: regionCode, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/").concat(this.configuration.encodeParam({ name: "countyId", value: countyId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }));
    ...
    ReportingControllerService.prototype.getCourtCoverageForStateReportUsingGET = function (regionCode, countyId, urWindowInDays, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (regionCode === null || regionCode === undefined) {
    ...
    ReportingControllerService.prototype.getCourtCoverageReportUsingGET = function (urWindowInDays, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var localVarQueryParameters = new http_1.HttpParams({ encoder: this.encoder });
        if (urWindowInDays !== undefined && urWindowInDays !== null) {
        ...
        var localVarPath = "/api/v1/reports/court-coverage";
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            params: localVarQueryParameters,
            responseType: responseType_,
    ...
    ReportingControllerService.prototype.getLawfirmCoverageReportUsingGET = function (countyId, regionCode, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var localVarQueryParameters = new http_1.HttpParams({ encoder: this.encoder });
        if (countyId !== undefined && countyId !== null) {
        ...
        var localVarPath = "/api/v1/reports/court-coverage/lawfirms";
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            params: localVarQueryParameters,
            responseType: responseType_,
