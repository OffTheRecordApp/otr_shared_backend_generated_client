...
exports.RefundEligibilityControllerService = void 0;
...
var RefundEligibilityControllerService = /** @class */ (function () {
    function RefundEligibilityControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    RefundEligibilityControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    RefundEligibilityControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    RefundEligibilityControllerService.prototype.isRefundEligibleUsingGET = function (caseId, observe, reportProgress, options) {
    ...
    RefundEligibilityControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return RefundEligibilityControllerService;
}());
exports.RefundEligibilityControllerService = RefundEligibilityControllerService;
