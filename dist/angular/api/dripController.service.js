...
exports.DripControllerService = void 0;
...
var DripControllerService = /** @class */ (function () {
    function DripControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    DripControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    DripControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    DripControllerService.prototype.removeFromDripUsingDELETE = function (request, observe, reportProgress, options) {
    ...
    DripControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return DripControllerService;
}());
exports.DripControllerService = DripControllerService;
