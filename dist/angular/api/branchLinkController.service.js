...
exports.BranchLinkControllerService = void 0;
...
var BranchLinkControllerService = /** @class */ (function () {
    function BranchLinkControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    BranchLinkControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    BranchLinkControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    BranchLinkControllerService.prototype.createBranchLinkUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/branch/link";
    ...
    BranchLinkControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return BranchLinkControllerService;
}());
exports.BranchLinkControllerService = BranchLinkControllerService;
