...
exports.HouseholdMateControllerService = void 0;
...
var HouseholdMateControllerService = /** @class */ (function () {
    function HouseholdMateControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    HouseholdMateControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    HouseholdMateControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    HouseholdMateControllerService.prototype.acceptHouseholdInviteUsingPUT = function (email, token, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/household-mates/accept-invite";
    ...
    HouseholdMateControllerService.prototype.cancelHouseholdMateInviteUsingDELETE = function (inviteeEmail, userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        if (inviteeEmail !== undefined && inviteeEmail !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, inviteeEmail, 'inviteeEmail');
        }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        if (localVarHttpHeaderAcceptSelected === undefined) {
        ...
        var localVarPath = "/api/v1/household-mates/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/invite");
    ...
    HouseholdMateControllerService.prototype.getHouseholdMatesUsingGET = function (userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/household-mates/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }));
    ...
    HouseholdMateControllerService.prototype.inviteHouseholdMateUsingPOST = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
    ...
    HouseholdMateControllerService.prototype.removeHouseholdMateUsingDELETE = function (mateUserId, userId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        if (mateUserId !== undefined && mateUserId !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, mateUserId, 'mateUserId');
        }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        if (localVarHttpHeaderAcceptSelected === undefined) {
        ...
        var localVarPath = "/api/v1/household-mates/".concat(this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }));
        return this.httpClient.request('delete', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            params: localVarQueryParameters,
            responseType: responseType_,
    ...
    HouseholdMateControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], HouseholdMateControllerService);
    return HouseholdMateControllerService;
}());
exports.HouseholdMateControllerService = HouseholdMateControllerService;
