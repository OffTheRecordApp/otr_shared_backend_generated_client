...
export class CaseCounterOfferControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCounterOfferByCounterIdUsingGET(caseId: string, counterId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<GetCounterOfferResponse>;
    public getCounterOfferByCounterIdUsingGET(caseId: string, counterId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<GetCounterOfferResponse>>;
    public getCounterOfferByCounterIdUsingGET(caseId: string, counterId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<GetCounterOfferResponse>>;
    public getCounterOfferByCounterIdUsingGET(caseId: string, counterId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        if (caseId === null || caseId === undefined) {
        ...
        let localVarPath = `/api/v1/cases/${this.configuration.encodeParam({name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/counters/${this.configuration.encodeParam({name: "counterId", value: counterId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}`;
