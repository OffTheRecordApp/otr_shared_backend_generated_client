...
exports.SnsListenerControllerService = void 0;
...
var SnsListenerControllerService = /** @class */ (function () {
    function SnsListenerControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    SnsListenerControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    SnsListenerControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    SnsListenerControllerService.prototype.handleBounceComplaintEmailsUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/blacklists/ses/emails/";
    ...
    SnsListenerControllerService.prototype.handleIncomingEmailsUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/ses/inbound-emails";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    SnsListenerControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return SnsListenerControllerService;
}());
exports.SnsListenerControllerService = SnsListenerControllerService;
