...
export class CaseReferralCodeControllerService {
     ...
     */
    public applyReferralCodeUsingPOST(caseId: string, codeId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<MatchCaseResponse>;
    public applyReferralCodeUsingPOST(caseId: string, codeId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<MatchCaseResponse>>;
    public applyReferralCodeUsingPOST(caseId: string, codeId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<MatchCaseResponse>>;
    public applyReferralCodeUsingPOST(caseId: string, codeId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
