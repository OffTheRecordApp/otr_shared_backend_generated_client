...
exports.LawfirmSurchargeControllerService = void 0;
...
var LawfirmSurchargeControllerService = /** @class */ (function () {
    function LawfirmSurchargeControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmSurchargeControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmSurchargeControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmSurchargeControllerService.prototype.listLawfirmSurchargesUsingGET = function (lawfirmId, featureType, observe, reportProgress, options) {
        ...
        if (featureType !== undefined && featureType !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, featureType, 'featureType');
        }
        ...
        var localVarPath = "/api/v1/lawfirms/".concat(this.configuration.encodeParam({ name: "lawfirmId", value: lawfirmId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/surcharges");
    ...
    LawfirmSurchargeControllerService.prototype.removeSurchargesUsingDELETE = function (lawfirmId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (lawfirmId === null || lawfirmId === undefined) {
    ...
    LawfirmSurchargeControllerService.prototype.saveLawfirmSurchargesUsingPOST = function (lawfirmId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (lawfirmId === null || lawfirmId === undefined) {
    ...
    LawfirmSurchargeControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], LawfirmSurchargeControllerService);
    return LawfirmSurchargeControllerService;
}());
exports.LawfirmSurchargeControllerService = LawfirmSurchargeControllerService;
