...
exports.TicketReviewControllerService = void 0;
...
var TicketReviewControllerService = /** @class */ (function () {
    function TicketReviewControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    TicketReviewControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    TicketReviewControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    TicketReviewControllerService.prototype.getTicketReviewInfoUsingGET = function (citationId, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/citations/".concat(this.configuration.encodeParam({ name: "citationId", value: citationId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/ticket-review");
    ...
    TicketReviewControllerService.prototype.persistTicketEvaluationUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/ticket-evaluation";
    ...
    TicketReviewControllerService.prototype.updateTicketEvaluationRequestUsingPUT = function (ticketEvaluationRequestId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/ticket-evaluation/".concat(this.configuration.encodeParam({ name: "ticketEvaluationRequestId", value: ticketEvaluationRequestId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }));
    ...
    TicketReviewControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return TicketReviewControllerService;
}());
exports.TicketReviewControllerService = TicketReviewControllerService;
