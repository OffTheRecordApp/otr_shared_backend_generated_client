...
exports.ReferralSourceControllerService = void 0;
...
var ReferralSourceControllerService = /** @class */ (function () {
    function ReferralSourceControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ReferralSourceControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ReferralSourceControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ReferralSourceControllerService.prototype.getUserReferralSourceTypesUsingGET = function (flavor, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/referrals/sources";
    ...
    ReferralSourceControllerService.prototype.setReferralSourceUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
    ...
    ReferralSourceControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], ReferralSourceControllerService);
    return ReferralSourceControllerService;
}());
exports.ReferralSourceControllerService = ReferralSourceControllerService;
