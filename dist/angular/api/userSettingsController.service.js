...
exports.UserSettingsControllerService = void 0;
...
var UserSettingsControllerService = /** @class */ (function () {
    function UserSettingsControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    UserSettingsControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    UserSettingsControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    UserSettingsControllerService.prototype.getUserSettingUsingGET = function (name, userId, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/user-settings/" + this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" });
    ...
    UserSettingsControllerService.prototype.getUserSettingsUsingPOST = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/user-settings/" + this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }) + "/get-settings";
    ...
    UserSettingsControllerService.prototype.updateUserSettingUsingPOST = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/user-settings/" + this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }) + "/setting";
        return this.httpClient.request('post', "" + this.configuration.basePath + localVarPath, {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    UserSettingsControllerService.prototype.updateUserSettingsUsingPOST = function (userId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (userId === null || userId === undefined) {
        ...
        var localVarPath = "/api/v1/user-settings/" + this.configuration.encodeParam({ name: "userId", value: userId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }) + "/update-settings";
        return this.httpClient.request('post', "" + this.configuration.basePath + localVarPath, {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    UserSettingsControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return UserSettingsControllerService;
}());
exports.UserSettingsControllerService = UserSettingsControllerService;
