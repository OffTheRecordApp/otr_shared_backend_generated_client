...
exports.SingleSignOnControllerService = void 0;
...
var SingleSignOnControllerService = /** @class */ (function () {
    function SingleSignOnControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    SingleSignOnControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    SingleSignOnControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    SingleSignOnControllerService.prototype.loginWithSSOUsingPOST = function (brandId, email, isAdmin, password, observe, reportProgress, options) {
        ...
        if (brandId !== undefined && brandId !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, brandId, 'brandId');
        }
        ...
        var localVarPath = "/api/v1/authentication/sso/login";
    ...
    SingleSignOnControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], SingleSignOnControllerService);
    return SingleSignOnControllerService;
}());
exports.SingleSignOnControllerService = SingleSignOnControllerService;
