...
exports.SocialLoginControllerService = void 0;
...
var SocialLoginControllerService = /** @class */ (function () {
    function SocialLoginControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    SocialLoginControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    SocialLoginControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    SocialLoginControllerService.prototype.appleConnectUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/connect/apple";
    ...
    SocialLoginControllerService.prototype.facebookConnectUsingPOST = function (providerId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/connect/".concat(this.configuration.encodeParam({ name: "providerId", value: providerId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }));
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    SocialLoginControllerService.prototype.googleConnectUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/connect/google";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    SocialLoginControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return SocialLoginControllerService;
}());
exports.SocialLoginControllerService = SocialLoginControllerService;
