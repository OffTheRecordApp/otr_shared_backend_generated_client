...
exports.CaseReferralCodeControllerService = void 0;
...
var CaseReferralCodeControllerService = /** @class */ (function () {
    function CaseReferralCodeControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CaseReferralCodeControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CaseReferralCodeControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CaseReferralCodeControllerService.prototype.applyReferralCodeUsingPOST = function (caseId, codeId, observe, reportProgress, options) {
    ...
    CaseReferralCodeControllerService.prototype.removeReferralCodeFromCaseUsingDELETE = function (caseId, codeId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
    ...
    CaseReferralCodeControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], CaseReferralCodeControllerService);
    return CaseReferralCodeControllerService;
}());
exports.CaseReferralCodeControllerService = CaseReferralCodeControllerService;
