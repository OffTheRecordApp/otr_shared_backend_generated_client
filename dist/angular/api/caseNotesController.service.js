...
exports.CaseNotesControllerService = void 0;
...
var CaseNotesControllerService = /** @class */ (function () {
    function CaseNotesControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CaseNotesControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CaseNotesControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CaseNotesControllerService.prototype.getCaseNotesUsingGET = function (caseId, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/notes");
    ...
    CaseNotesControllerService.prototype.saveCaseNotesUsingPOST = function (caseId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
    ...
    CaseNotesControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CaseNotesControllerService;
}());
exports.CaseNotesControllerService = CaseNotesControllerService;
