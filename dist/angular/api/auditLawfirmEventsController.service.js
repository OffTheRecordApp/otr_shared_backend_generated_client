...
exports.AuditLawfirmEventsControllerService = void 0;
...
var AuditLawfirmEventsControllerService = /** @class */ (function () {
    function AuditLawfirmEventsControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    AuditLawfirmEventsControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    AuditLawfirmEventsControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    AuditLawfirmEventsControllerService.prototype.listLawfirmAuditEventsByCursorUsingGET = function (lawfirmId, excludeTypes, includeTypes, limit, nextPageToken, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/lawfirms/".concat(this.configuration.encodeParam({ name: "lawfirmId", value: lawfirmId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/audit-events");
    ...
    AuditLawfirmEventsControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], AuditLawfirmEventsControllerService);
    return AuditLawfirmEventsControllerService;
}());
exports.AuditLawfirmEventsControllerService = AuditLawfirmEventsControllerService;
