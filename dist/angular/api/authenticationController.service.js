...
exports.AuthenticationControllerService = void 0;
...
var AuthenticationControllerService = /** @class */ (function () {
    function AuthenticationControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    AuthenticationControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    AuthenticationControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    AuthenticationControllerService.prototype.getUserInfoUsingGET = function (observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/authentication/user";
    ...
    return AuthenticationControllerService;
}());
exports.AuthenticationControllerService = AuthenticationControllerService;
