...
// @ts-ignore
import { LawfirmSupportedStateRequest } from '../model/lawfirmSupportedStateRequest';
// @ts-ignore
...
export class LawfirmControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveLawfirmSupportedStateUsingPOST(lawfirmId: number, request: LawfirmSupportedStateRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public saveLawfirmSupportedStateUsingPOST(lawfirmId: number, request: LawfirmSupportedStateRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public saveLawfirmSupportedStateUsingPOST(lawfirmId: number, request: LawfirmSupportedStateRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public saveLawfirmSupportedStateUsingPOST(lawfirmId: number, request: LawfirmSupportedStateRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (lawfirmId === null || lawfirmId === undefined) {
