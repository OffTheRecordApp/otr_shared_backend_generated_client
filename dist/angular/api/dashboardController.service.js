...
exports.DashboardControllerService = void 0;
...
var DashboardControllerService = /** @class */ (function () {
    ...
    // @ts-ignore
    DashboardControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    DashboardControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    DashboardControllerService.prototype.getBookingsUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/console/bookings";
    ...
    DashboardControllerService.prototype.getRegisteredUsersUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/console/users";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.getUserRegistrationsUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/console/registrations";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.listCasesByStatusUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (graphRequest === null || graphRequest === undefined) {
        ...
        var localVarPath = "/api/v1/console/cases/status";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.listCustomersUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (graphRequest === null || graphRequest === undefined) {
        ...
        var localVarPath = "/api/v1/console/customers";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.listDropoffsUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (graphRequest === null || graphRequest === undefined) {
        ...
        var localVarPath = "/api/v1/console/dropoff";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.listExpensesUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (graphRequest === null || graphRequest === undefined) {
        ...
        var localVarPath = "/api/v1/console/expenses";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
    ...
    DashboardControllerService.prototype.listLawyerLeadsUsingPOST = function (graphRequest, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (graphRequest === null || graphRequest === undefined) {
        ...
        var localVarPath = "/api/v1/console/lawyer-leads";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: graphRequest,
            responseType: responseType_,
