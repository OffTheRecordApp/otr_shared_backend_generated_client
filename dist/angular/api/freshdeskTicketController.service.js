...
exports.FreshdeskTicketControllerService = void 0;
...
var FreshdeskTicketControllerService = /** @class */ (function () {
    function FreshdeskTicketControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    FreshdeskTicketControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    FreshdeskTicketControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    FreshdeskTicketControllerService.prototype.mergeTicketUsingPOST = function (ticketId, request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/freshdesk/webhook/ticket/".concat(this.configuration.encodeParam({ name: "ticketId", value: ticketId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/merge");
    ...
    FreshdeskTicketControllerService.prototype.ticketStatusChangeHookUsingPUT = function (ticketId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (ticketId === null || ticketId === undefined) {
        ...
        var localVarPath = "/api/v1/freshdesk/ticket/".concat(this.configuration.encodeParam({ name: "ticketId", value: ticketId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/webhook/status-change");
    ...
    FreshdeskTicketControllerService.prototype.updateFreshdeskTicketUsingPUT = function (ticketId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (ticketId === null || ticketId === undefined) {
        ...
        var localVarPath = "/api/v1/freshdesk/ticket/".concat(this.configuration.encodeParam({ name: "ticketId", value: ticketId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }));
        return this.httpClient.request('put', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    FreshdeskTicketControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return FreshdeskTicketControllerService;
}());
exports.FreshdeskTicketControllerService = FreshdeskTicketControllerService;
