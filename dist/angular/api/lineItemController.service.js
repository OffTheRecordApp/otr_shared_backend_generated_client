...
exports.LineItemControllerService = void 0;
...
var LineItemControllerService = /** @class */ (function () {
    function LineItemControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LineItemControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LineItemControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LineItemControllerService.prototype.deleteCaseLineItemUsingDELETE = function (caseId, lineItemId, observe, reportProgress, options) {
    ...
    LineItemControllerService.prototype.getLineItemTypesUsingGET = function (observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var localVarHeaders = this.defaultHeaders;
        var localVarHttpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        var localVarPath = "/api/v1/lineitems";
    ...
    LineItemControllerService.prototype.getLineItemsUsingGET = function (caseId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/line-items");
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            responseType: responseType_,
            withCredentials: this.configuration.withCredentials,
    ...
    LineItemControllerService.prototype.insertCaseLineItemUsingPOST = function (caseId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
        ...
        var localVarPath = "/api/v1/cases/".concat(this.configuration.encodeParam({ name: "caseId", value: caseId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/lineitems");
    ...
    LineItemControllerService.prototype.updateCaseLineItemUsingPUT = function (caseId, lineItemId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (caseId === null || caseId === undefined) {
    ...
    LineItemControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], LineItemControllerService);
    return LineItemControllerService;
}());
exports.LineItemControllerService = LineItemControllerService;
