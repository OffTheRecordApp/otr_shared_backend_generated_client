...
exports.ActivityFeedControllerService = void 0;
...
var ActivityFeedControllerService = /** @class */ (function () {
    function ActivityFeedControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    ActivityFeedControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    ActivityFeedControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    ActivityFeedControllerService.prototype.listActivityFeedUsingGET = function (limit, nextPageToken, previousPageToken, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/activity-feed";
    ...
    ActivityFeedControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], ActivityFeedControllerService);
    return ActivityFeedControllerService;
}());
exports.ActivityFeedControllerService = ActivityFeedControllerService;
