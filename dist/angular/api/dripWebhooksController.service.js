...
exports.DripWebhooksControllerService = void 0;
...
var DripWebhooksControllerService = /** @class */ (function () {
    function DripWebhooksControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    DripWebhooksControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    DripWebhooksControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    DripWebhooksControllerService.prototype.handleBounceOrComplaintEventUsingPOST = function (request, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/webhooks/drip/bounce-or-complaint";
    ...
    DripWebhooksControllerService.prototype.handleDripWebhookUsingPOST = function (request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (request === null || request === undefined) {
        ...
        var localVarPath = "/api/v1/drip/webhooks";
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    DripWebhooksControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return DripWebhooksControllerService;
}());
exports.DripWebhooksControllerService = DripWebhooksControllerService;
