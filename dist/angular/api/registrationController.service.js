...
exports.RegistrationControllerService = void 0;
...
var RegistrationControllerService = /** @class */ (function () {
    function RegistrationControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    RegistrationControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    RegistrationControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    RegistrationControllerService.prototype.registerNewUserUsingPOST = function (request, observe, reportProgress, options) {
    ...
    RegistrationControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return RegistrationControllerService;
}());
exports.RegistrationControllerService = RegistrationControllerService;
