...
exports.LawfirmSettingsControllerService = void 0;
...
var LawfirmSettingsControllerService = /** @class */ (function () {
    function LawfirmSettingsControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    LawfirmSettingsControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    LawfirmSettingsControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    LawfirmSettingsControllerService.prototype.getLawfirmSettingUsingGET = function (lawfirmId, name, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/lawfirm-settings/".concat(this.configuration.encodeParam({ name: "lawfirmId", value: lawfirmId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/setting");
    ...
    LawfirmSettingsControllerService.prototype.getLawfirmSettingsUsingGET = function (lawfirmId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (lawfirmId === null || lawfirmId === undefined) {
        ...
        var localVarPath = "/api/v1/lawfirms/".concat(this.configuration.encodeParam({ name: "lawfirmId", value: lawfirmId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }), "/settings");
        return this.httpClient.request('get', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            responseType: responseType_,
            withCredentials: this.configuration.withCredentials,
    ...
    LawfirmSettingsControllerService.prototype.updateLawfirmSettingUsingPOST = function (lawfirmId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (lawfirmId === null || lawfirmId === undefined) {
    ...
    LawfirmSettingsControllerService.prototype.updateLawfirmSettingsUsingPOST = function (lawfirmIdString, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/lawfirms/".concat(this.configuration.encodeParam({ name: "lawfirmIdString", value: lawfirmIdString, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined }), "/settings");
        return this.httpClient.request('post', "".concat(this.configuration.basePath).concat(localVarPath), {
            context: localVarHttpContext,
            body: request,
            responseType: responseType_,
    ...
    LawfirmSettingsControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    ], LawfirmSettingsControllerService);
    return LawfirmSettingsControllerService;
}());
exports.LawfirmSettingsControllerService = LawfirmSettingsControllerService;
