...
exports.CustomerServiceAgentControllerService = void 0;
...
var CustomerServiceAgentControllerService = /** @class */ (function () {
    function CustomerServiceAgentControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    CustomerServiceAgentControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    CustomerServiceAgentControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    CustomerServiceAgentControllerService.prototype.getCustomerServiceAgentsUsingGET = function (isActive, observe, reportProgress, options) {
        ...
        var localVarPath = "/api/v1/cs-agents";
    ...
    CustomerServiceAgentControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return CustomerServiceAgentControllerService;
}());
exports.CustomerServiceAgentControllerService = CustomerServiceAgentControllerService;
