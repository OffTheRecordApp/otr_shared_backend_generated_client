...
exports.NotesControllerService = void 0;
...
var NotesControllerService = /** @class */ (function () {
    function NotesControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    NotesControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    NotesControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    NotesControllerService.prototype.createNoteUsingPOST = function (request, observe, reportProgress, options) {
    ...
    NotesControllerService.prototype.deleteNoteUsingDELETE = function (noteId, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        var localVarPath = "/api/v1/notes/".concat(this.configuration.encodeParam({ name: "noteId", value: noteId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64" }));
    ...
    NotesControllerService.prototype.updateNoteUsingPUT = function (noteId, request, observe, reportProgress, options) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (noteId === null || noteId === undefined) {
    ...
    NotesControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return NotesControllerService;
}());
exports.NotesControllerService = NotesControllerService;
