...
exports.MessagesControllerService = void 0;
...
var MessagesControllerService = /** @class */ (function () {
    function MessagesControllerService(httpClient, basePath, configuration) {
    ...
    // @ts-ignore
    MessagesControllerService.prototype.addToHttpParams = function (httpParams, value, key) {
    ...
    MessagesControllerService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
        var _this = this;
        if (value == null) {
            return httpParams;
        }
    ...
    MessagesControllerService.prototype.listMessagesByEntityUsingGET = function (lawfirmId, length, page, userIds, observe, reportProgress, options) {
        ...
        if (userIds !== undefined && userIds !== null) {
            localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, userIds, 'userIds');
        }
    ...
    MessagesControllerService = __decorate([
        (0, core_1.Injectable)({
            providedIn: 'root'
        }),
    ...
    return MessagesControllerService;
}());
exports.MessagesControllerService = MessagesControllerService;
