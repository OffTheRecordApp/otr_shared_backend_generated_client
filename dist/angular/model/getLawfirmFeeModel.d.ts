 ...
 */
import { GetCompetitionResponseModel } from './getCompetitionResponseModel';
export interface GetLawfirmFeeModel {
    accountFee?: number;
    classification?: GetLawfirmFeeModel.ClassificationEnum;
    competition?: GetCompetitionResponseModel;
    courtFee?: number;
    courtId?: number;
    isDeleted?: boolean;
    lawfirmFee?: number;
    refundEligibility?: GetLawfirmFeeModel.RefundEligibilityEnum;
    violationId?: number;
    violationName?: string;
}
export declare namespace GetLawfirmFeeModel {
