...
export namespace SendEmailToUserRequest {
    ...
    export type ReviewPlatformEnum = 'FACEBOOK' | 'GOOGLE_MY_BUSINESS' | 'GOOGLE_PLAY_STORE' | 'HIGHYA' | 'IOS_APP_STORE' | 'REVIEWS_IO' | 'TRUST_PILOT';
    export const ReviewPlatformEnum = {
        Facebook: 'FACEBOOK' as ReviewPlatformEnum,
        GoogleMyBusiness: 'GOOGLE_MY_BUSINESS' as ReviewPlatformEnum,
        GooglePlayStore: 'GOOGLE_PLAY_STORE' as ReviewPlatformEnum,
        Highya: 'HIGHYA' as ReviewPlatformEnum,
        IosAppStore: 'IOS_APP_STORE' as ReviewPlatformEnum,
        ReviewsIo: 'REVIEWS_IO' as ReviewPlatformEnum,
        TrustPilot: 'TRUST_PILOT' as ReviewPlatformEnum
    };
}
