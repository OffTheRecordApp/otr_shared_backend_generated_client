...
export interface MarkCaseAsResolvedResponse { 
    caseStatus?: MarkCaseAsResolvedResponse.CaseStatusEnum;
    isDeprecated?: boolean;
    lawfirmFriendlyDescription?: string;
    lawfirmFriendlyName?: string;
    statusCategory?: MarkCaseAsResolvedResponse.StatusCategoryEnum;
    statusId?: number;
}
export namespace MarkCaseAsResolvedResponse {
