...
export declare namespace LawfirmInboxMessageDomain {
    ...
    type LawfirmCaseDecisionStatusEnum = 'ACCEPTED' | 'CREATED' | 'DECLINED' | 'EXPIRED' | 'PENDING' | 'REMATCHED' | 'REMATCHED_REFERRAL';
    const LawfirmCaseDecisionStatusEnum: {
        Accepted: LawfirmCaseDecisionStatusEnum;
        Created: LawfirmCaseDecisionStatusEnum;
        Declined: LawfirmCaseDecisionStatusEnum;
        Expired: LawfirmCaseDecisionStatusEnum;
        Pending: LawfirmCaseDecisionStatusEnum;
        Rematched: LawfirmCaseDecisionStatusEnum;
        RematchedReferral: LawfirmCaseDecisionStatusEnum;
    };
}
