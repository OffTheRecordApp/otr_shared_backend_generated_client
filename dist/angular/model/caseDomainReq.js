...
exports.CaseDomainReq = void 0;
var CaseDomainReq;
(function (CaseDomainReq) {
    CaseDomainReq.CaseStatusEnum = {
    ...
    CaseDomainReq.CaseStatusCategoryEnum = {
        Active: 'ACTIVE',
        Cancelled: 'CANCELLED',
        Resolved: 'RESOLVED',
        Unconfirmed: 'UNCONFIRMED'
    };
    CaseDomainReq.RefundEligibilityEnum = {
        FullRefund: 'FULL_REFUND',
        NoRefund: 'NO_REFUND'
    };
})(CaseDomainReq = exports.CaseDomainReq || (exports.CaseDomainReq = {}));
