...
(function (GetLawfirmSummaryCaseRequest) {
    GetLawfirmSummaryCaseRequest.CaseStatusCategoriesEnum = {
        Active: 'ACTIVE',
        Cancelled: 'CANCELLED',
        Resolved: 'RESOLVED',
        Unconfirmed: 'UNCONFIRMED'
    };
    GetLawfirmSummaryCaseRequest.CaseStatusesEnum = {
    ...
    GetLawfirmSummaryCaseRequest.ExcludedCaseStatusesEnum = {
        AmendedDownWithinClass: 'AMENDED_DOWN_WITHIN_CLASS',
        AmendedFullFine: 'AMENDED_FULL_FINE',
        AmendedIncreasedFine: 'AMENDED_INCREASED_FINE',
        AmendedNoFine: 'AMENDED_NO_FINE',
