...
(function (LawfirmInboxMessageDomain) {
    LawfirmInboxMessageDomain.AuthorRoleTypeEnum = {
        Admin: 'ADMIN',
        Defendant: 'DEFENDANT',
    ...
    LawfirmInboxMessageDomain.CaseStatusEnum = {
    ...
    LawfirmInboxMessageDomain.CaseStatusCategoryEnum = {
        Active: 'ACTIVE',
        Cancelled: 'CANCELLED',
        Resolved: 'RESOLVED',
        Unconfirmed: 'UNCONFIRMED'
    };
    LawfirmInboxMessageDomain.LawfirmCaseDecisionStatusEnum = {
        Accepted: 'ACCEPTED',
        Created: 'CREATED',
        Declined: 'DECLINED',
        Expired: 'EXPIRED',
