...
export declare namespace AddViolationResponse {
    type RefundEligibilityTypeEnum = 'FULL_REFUND' | 'NO_REFUND';
    const RefundEligibilityTypeEnum: {
        FullRefund: RefundEligibilityTypeEnum;
        NoRefund: RefundEligibilityTypeEnum;
    };
